...
class Notifications extends MY_Controller
{
    ...
    function index()
    {
        ...
        $this->core_page('notifications/index', $meta, $this->data);
    }
    ...
    function add()
    {
        ...
        if ($this->form_validation->run() == true) {
            $data = array(
                ...
                'from_date' => $this->input->post('from_date') ? $this->cus->fld($this->input->post('from_date')) : NULL,
                'till_date' => $this->input->post('to_date') ? $this->cus->fld($this->input->post('to_date')) : NULL,
