 ...
 */
$config['site_title']                 = "WeERP";       // Site Title, example.com This is not more functional
$config['admin_email']                = "veasna.rin@sunfixconsulting.com"; // Admin Email, admin@example.com This is not more functional
