...
$route['clogin'] = 'auth/clogin';
$route['clogin/(:any)'] = 'auth/clogin/$1';
$route['logout'] = 'auth/logout';
$route['logout/(:any)'] = 'auth/logout/$1';
$route['register'] = 'auth/register';
$route['forgot_password'] = 'auth/forgot_password';
$route['sales/(:num)'] = 'sales/index/$1';
$route['sale_orders/(:num)'] = 'sale_orders/index/$1';
$route['purchase_requests/(:num)'] = 'purchase_requests/index/$1';
$route['purchase_orders/(:num)'] = 'purchase_orders/index/$1';
$route['products/(:num)'] = 'products/index/$1';
$route['purchases/(:num)'] = 'purchases/index/$1';
$route['quotes/(:num)'] = 'quotes/index/$1';
$route['pawns/(:num)'] = 'pawns/index/$1';
