...
class Paypal_payments extends CI_Model
{
    ...
    function get_balance()
    {
        ...
        if (!$this->paypal_pro->APICallSuccessful($PayPalResult['ACK'])) {
            ...
            return array('amount' => $data['PayPalResult']['BALANCERESULTS'], 'time' => $this->cus->hrld($data['PayPalResult']['TIMESTAMP']));
            //$this->load->view('get_balance', $data);
        }
    }

    function Do_direct_payment($amount = false, $currency = false, $cc = false, $desc = '')
    {
        $DPFields = array(
    ...
    function Get_transaction_details($transactionid = false)
    {
        $GTDFields = array(
