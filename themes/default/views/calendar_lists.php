...
<script>
    $(document).ready(function () {
        oTable = $('#LTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('calendar/getCalendarLists/?id='.$id) ?>',
...
<?php if ($Owner || $GP['bulk_actions']) {
	    echo form_open('calendar/calendar_actions', 'id="action-form"');
	}
?>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
					...
					<ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                       <li>
							<li>
								<a href="<?= site_url("calendar/import_csv") ?>" ><i class="fa fa-plus-circle"></i> 
									<?= lang('import_csv') ?>
								</a>
							</li>
                ...
                <div class="table-responsive">
                    <table id="LTable" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr class="active">
							...
							<th width='100'><?= lang("start") ?></th>
							<th width='100'><?= lang("end") ?></th>
