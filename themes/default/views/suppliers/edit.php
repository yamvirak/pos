            ...
            <div class="row">
                <div class="col-md-6">
					<div class="form-group code">
                        <?= lang("code", "code"); ?>
                        <?php echo form_input('code', $supplier->code, 'class="form-control tip" id="code" data-bv-notempty="true"'); ?>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?= lang("phone", "phone"); ?>
                        <input type="tel" name="phone" class="form-control" required="required" id="phone" value="<?= $supplier->phone ?>"/>
                    </div>
					<div class="form-group">
                        <?= lang("vat_no", "vat_no"); ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?php echo form_textarea('address', $supplier->address, 'class="form-control" id="address" required="required"'); ?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
