    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            oTable = $('#DepData').dataTable({
                ...
                'sAjaxSource': '<?= site_url('suppliers/get_deposits/'.$company->id) ?>',
                ...
                "aoColumns": [{"mRender": fld}, {"mRender": currencyFormat}, null, null, {"bSortable": false,"mRender": attachment}, {"bSortable": false}]
            });
