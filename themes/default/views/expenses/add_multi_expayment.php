...
<div class="modal-dialog" style="width:50% !important">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_multi_expayment'); ?></h4>
        </div>
		...
		foreach($inv as $row){
			if($b==1){
				...
				$pid .='ExpenseID'.$row->id;
			}
			$total = $row->grand_total - ($row->paid+$row->discount);
			$grand_total = $total;
			$total_amount += $total;
			$tbody .='<tr>	
        ...
        echo form_open_multipart("purchases/add_multi_expayment/" . $pid, $attrib);
		?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_multi_expayment', lang('add_multi_expayment'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
