                    ...
                    <?php if (!empty($payments)) {
                        foreach ($payments as $payment) { ?>
                            <tr class="row<?= $payment->id ?>">
                                ...
                                <td class="text-right"><?= $this->cus->formatMoney($payment->amount *(-1)) . ' ' . (($payment->attachment) ? '<a href="' . site_url('welcome/download/' . $payment->attachment) . '"><i class="fa fa-chain"></i></a>' : ''); ?></td>
                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <a href="<?= site_url('purchases/edit_payment_return/' . $payment->id) ?>" data-toggle="modal" data-target="#myModal2"><i class="fa fa-edit"></i></a>
