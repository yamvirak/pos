        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <?php if($pos_settings->table_enable == 1 && $sid){
                              $sbill_items = $this->pos_model->getOpenBillByID($sid);
                              $sbill_class = $sbill_items->saleman_id > 0 ? "borange": "blightBlue";
                    ?>
                    ...
                    <!--<li class="dropdown">
                        <a class="btn borange pos-tip" id="count_money" title="<span><?=lang('count_money')?></span>" data-placement="bottom" data-html="true" data-backdrop="static" href="<?=site_url('pos/count_money')?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-money"></i>
                        </a>
                    </li>-->

                    <li class="dropdown">
                        <a class="btn bdarkGreen pos-tip" id="register_items" title="<?=lang('register_items')?>" data-placement="bottom" data-html="true" href="<?=site_url('pos/register_items')?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-folder-open-o"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        <a class="btn borange pos-tip" id="close_register" title="<?=lang('close_register')?>" data-placement="bottom" data-html="true" data-backdrop="static" href="<?=site_url('pos/close_register')?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-times-circle"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a target="_blank" class="btn borange pos-tip" id="add_expense" title="<?=lang('add_expense')?>"  href="<?=site_url('purchases/add_expense')?>">
                ...
                <div id="pos">
                    ...
                    <div class="col-xs-5">
                        ...
                        <div id="left-top">
                            ...
                            <input type="hidden" name="sale_status" id="sale_status"/>
                            <input type="hidden" name="agency_id" id="slagency" />
                            <input type="hidden" name="reference_no" id="pos_reference_no" />
                            <input type="hidden" name="slpayment_term" id="slpayment_term" />
                        ...
                        <div id="print">
                                    ...
                                    <table class="table items table-striped table-bordered table-condensed table-hover sortable_table"
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($Settings->show_unit == 1) { ?>                                           
                                                <th <?= $head_row ?> width="25%"><?=lang("unit");?></th>
                                            <?php } ?>
                            ...
                            <div id="left-bottom">
                                        ...
                                        <div class="row">
                                            <?php 
                                                ...
                                                <div class="btn-group-vertical btn-block">
                                                    ...
                                                    <a href="<?= site_url("pos/add_table"); ?>" type="button" class="btn btn-primary btn-block btn-flat" style="height:66px; line-height: 50px;" >
                                                            <i class="fa fa-building-o"></i>​ Table

                                                            <?php 
                                                                echo ($billsTable != false)? "($billsTable->name)" : 'N/A';
                                                            ?>
                                                        </a>
                                                    <?php } else { ?>
                                                        <a href="<?= site_url("pos/add_table"); ?>" type="button" class="btn btn-primary btn-block btn-flat" style="height:66px; line-height: 50px;" >
                                                    ...
                                                    <?php } if($billsTable != false && $billsTable->available == 1){ ?>
                                                    
                                                    <a href="<?= site_url("pos/suspend_checkin/0/".$sid) ?>" id="<?= $billsTable->table_id  ?>" value="<?= $billsTable->table_name  ?>" time="<?= date("d/m/Y H:i",strtotime($billsTable->date));  ?>" class="btn btn-info btn-block btn-flat add_suspend_item" data-toggle="modal" data-target="#myModal">
                                                    ...
                                                    <button type="button" id="<?= $billsTable->table_id  ?>" value="<?= $billsTable->table_name  ?>" time="<?= date("d/m/Y H:i",strtotime($billsTable->date));  ?>" class="btn btn-primary btn-block btn-flat add_suspend_item hide" style="line-height: 0px;height: 0!important;">
                                                        &nbsp;
                                                    </button>
                                                    ...
                                                    <a hreff="<?= site_url("pos/delete_suspend/".$billsTable->table_id); ?>" class="btn btn-danger btn-block btn-flat delete_suspend" >
                                                ...
                                                <div class="col-xs-4" style="padding: 0;">
                                                    <div class="btn-group-vertical btn-block">
                                                        ...
                                                        <button <?= $payment_block ?> type="button" class="btn btn-info btn-block" id="print_bill">
                                                            <i class="fa fa-print"></i>
                                                            <?=lang('bill');?>
                                                        </button>
                                                        <?php if ($billsTable != false){?>
                                                            <a href="<?= site_url("pos/add_table?v=1&bill_id=".$billsTable->id) ?>" id="move_suspend" type="button" class="btn btn-danger btn-block">
                                                ...
                                                <div class="col-xs-4" style="padding: 0;">
                                                    <button <?= $payment_block ?> type="button" class="btn btn-success btn-block payment" id="payment" style="height:100px;">
                                            ...
                                            <?php }else { ?>
                                                <div class="col-xs-4" style="padding: 0;">
                                                    <div class="btn-group-vertical btn-block">                                                                                          
                                                        ...
                                                        <?php if($sid){ ?>
                                                            <a hreff="<?= site_url("pos/delete_suspend/".$sid); ?>" class="btn btn-danger btn-block btn-flat delete_suspend" id="reset">
                                                                <i class="fa fa-trash-o"></i>
                                                                <?= lang('cancel'); ?>
                                                            </a>
                                                        <?php } else { ?>
                                            ...
                                            <?php  }else{ ?>
                                                <div class="col-xs-4" style="padding: 0;">
                                                    <button type="button" class="btn btn-primary btn-block" id="print_bill" style="height:67px;">
                                                        <i class="fa fa-print"></i>
                                                        <?=lang('bill');?>
                                                    </button>
                                                </div>
                                                ...
                                                <?php if($pos_settings->pos_payment==0){ ?>
                                                    <div class="col-xs-4" style="padding: 0;">
                                                        ...
                                                        <button id="pos_payment" type="button" class="btn btn-success btn-block"  style="height:67px;">
                                ...
                                <input type="hidden" name="slcommission" value="" id="slcommission">
                                                    ...
                                                    <div class="cpcategory">
                                                        ...
                                                        foreach($categories as $category){
                                                                if($this->pos_settings->default_category==$category->id){
                                                                    echo "<button type='button' disabled-open-category='true' value='{$category->id}' class='animated ccategory btn btn-primary btn-danger category'>{$category->name}</button>"; 
                                                                }else{
                                                                    echo "<button type='button' disabled-open-category='true' value='{$category->id}' class='animated ccategory btn btn-primary category'>{$category->name}</button>";
                                                                }
                                                            }
                                                        ?>
                                                    </div>
            ...
            <div class="modal-body" id="payment_content">
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                                ...
                                <?php if ($Owner || $Admin || !$this->session->userdata('biller_id')) { ?>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php
                                                foreach ($billers as $biller) {
                                                     $btest = ($biller->company && $biller->company != '-' ? $biller->company : $biller->company);
                                                    $bl[$biller->id] = $btest;
                                                    $posbillers[] = array('logo' => $biller->logo, 'company' => $btest);
                                                ...
                                                <div class="no-project">
                                                    <?php
                                                     $pro[''] = "";
                                                        ...
                                                        foreach ($projects as $project) {
                                                            $pro[$project->id] = $project->name;
                                                        }
                                                    
                                                    echo form_dropdown('project', $pro, (isset($_POST['project']) ? $_POST['project'] : $Settings->project_id), 'id="project" class="form-control" data-placeholder="' . lang("select") . ' ' . lang("project") . '" style="width:100%;" ');
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <?php if ($this->config->item('crm')) { ?>
                        <div class="form-group">
                            <div class="row">
                                
                                <div class="col-sm-12 hidden">
                                    <?=form_textarea('feedback', '', 'id="feedback" class="form-control kb-text skip" style="height: 100px;" placeholder="' . lang('feedback') . '" maxlength="250"');?>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
                            ...
                            <table class="table table-bordered table-condensed table-striped">
                                <tbody>                                 
                                    ...
                                    <?php if($Settings->accounting == 1){ ?>
                                        <tr>
                                            <td width="50%" height="25" class="text-left bold"><?= lang("paying_to"); ?></td>
                                            <td colspan="<?= $count_currency ?>">
                                                <select  class="form-control paying_to" style="width:100%">
                                                    <?= $cash_account ?>
                                                </select>
                                            </td>
                                        </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (localStorage.getItem('poscustomers')) {
        ...
        localStorage.setItem('slpayment_term', '<?= $suspend_sale->payment_term ?>');
        <?php }
        ?>
        ...
        <?php if ($this->input->get('customers')) {?>
        if (!localStorage.getItem('positems')) {
            localStorage.setItem('poscustomers', <?=$this->input->get('customers');?>);
        } else if (!localStorage.getItem('poscustomers')) {
            localStorage.setItem('poscustomers', <?=$customer->id;?>);
        }
        <?php } else {?>
        if (!localStorage.getItem('poscustomers')) {
            localStorage.setItem('poscustomers', <?=$customer->id;?>);
        ...
        // ** Second_Customer_Option **

        $('#poscustomers').val(localStorage.getItem('poscustomers')).select2({
            minimumInputLength: 1,
            data: [],
            initSelection: function (element, callback) {
                $.ajax({
        ...
        if (KB) {
            ...
            var result = false, sct = '';
            $('#poscustomers').on('select2-opening', function () {
                sct = '';
                $('.select2-input').addClass('kb-text');
                display_keyboards();
                $('.select2-input').bind('change.keyboard', function (e, keyboard, el) {
                    ...
                    if(!el && sct.length > 0) {
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                if (res.results != null) {
                                    $('#poscustomers').select2({data: res}).select2('open');
                                    $('.select2-input').removeClass('select2-active');
                                } else {
                                    bootbox.alert('no_match_found');
                                    $('#poscustomers').select2('close');
                                    $('#test').click();
                                }
                            }
                        });
            ...
            $('#poscustomers').on('select2-close', function () {
                $('.select2-input').removeClass('kb-text');
                $('#test').click();
                $('select, .select').select2('destroy');
                $('select, .select').select2({minimumResultsForSearch: 7});
        ...
        $(document).on('click', '.addMorePayment', function () {
            var multi_payment = '<tr><th><select name="m_paid_by[]" class="form-control m_paid_by">';
                multi_payment += '<option value="cash" ><?= lang("cash") ?></option>';
                multi_payment += '<option value="Cheque" ><?= lang("cheque") ?></option>';
                multi_payment += '<option value="CC" ><?= lang("CC") ?></option>';
                multi_payment += '<option value="other" ><?= lang("other") ?></option>';
        ...
        $(document).on('click', '.category', function () {
            if (cat_id != $(this).val()) {
                ...
                <?php if($pos_settings->pos_category_fix==1 && $pos_settings->quick_pos != 1){ ?>
                    $(".category").removeClass("btn-danger");
        ...
        $(document).on('click', '.subcategory', function () {
            if (sub_cat_id != $(this).val()) {
                ...
                <?php if($pos_settings->pos_category_fix==1 && $pos_settings->quick_pos != 1){ ?>
                    $(".subcategory").removeClass("btn-danger");
                    $(this).addClass("btn-danger");
                <?php } ?>
        ...
        $(document).on('click', '#submit-sale', function () {
            ...
            <?php } ?>
                ...
                if (total_paid < gtotal) {
                    ...
                    if(allow_min_price == 1){
                        ...
                        bootbox.confirm("<?=lang('paid_l_t_payable');?>", function (res) {
                            if (res == true) {
                                ...
                                $('#slagency').val(localStorage.getItem('slagency'));
                                $('#slcommission').val(localStorage.getItem('slcommission'));
                    ...
                    $('#slcommission').val(localStorage.getItem('slcommission'));
                     $('#appointment_date').val(appointment_date);
                    $('#slpayment_term').val(localStorage.getItem('slpayment_term'));
