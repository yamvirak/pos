<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_service'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("rentals_configuration/add_service", $attrib); ?>
		<div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?php
                            ...
                            echo form_dropdown('service_type', $st, (isset($_POST['service_type']) ? $_POST['service_type'] : ''), 'id="service_type" class="form-control select" data-placeholder="' . lang("select") . ' ' . lang("service_type") . '" required="required" style="width:100%;" ');
                        ?>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
        				<?= lang("price", "price"); ?>
        				<?php echo form_input('price', '', 'class="form-control" id="price" required="required"'); ?>
        			</div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function(){
        var random_num = generateCardNo(8);
        $("#code").val(random_num);
