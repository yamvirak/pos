        ...
        <table>
                                        ...
                                        <table border="1" class="table_item_head">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-transform: uppercase;"> <strong>
                                                    <?= $this->cus->formatMoney($deposit_amount)?>
                                                </strong>
                                                </td>
                                            </tr>
                                            <tr>
            ...
            <tbody>
                <?php
                    ...
                    $amount_balance = (($return_sale ? (($inv->grand_total + $inv->rounding)+$return_sale->grand_total) : ($inv->grand_total + $inv->rounding)) - ($return_sale ? ($deposit_amount+$return_sale->paid) : $deposit_amount));
                    ...
                    $tfooter .= '<tr>
                        ...
                        if ($deposit_amount <= $inv->grand_total) {
                      
                            $tfooter .= '<tr>
                                            <td class="text_right" colspan="2"><b>'.lang("inv_paid").'</b></td>
                                            <td class="text_right"><b>'.$this->cus->formatMoney($return_sale ? ($deposit_amount+$return_sale->paid) : $deposit_amount).'</b></td>
