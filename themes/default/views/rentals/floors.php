<script>
    $(document).ready(function () {
        var oTable = $('#TaData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('rentals_configuration/getFloors') ?>',
...
<?php if ($Owner) {
    echo form_open('rentals_configuration/floor_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header box-header">
       <div class="action-header"> 
            <a href="<?php echo site_url('rentals_configuration/add_floor'); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <h2 class="blue"><i class="fa-fw fa fa-building"></i><?= lang('floors'); ?></h2>
