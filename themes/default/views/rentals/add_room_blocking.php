...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (localStorage.getItem('rtbcustomer')) {
            localStorage.removeItem('rtbcustomer');
        }
		...
		<?php if($this->input->get('customer')) { ?>
			if (!localStorage.getItem('rtitems')) {
				localStorage.setItem('rtbcustomer', <?=$this->input->get('customer');?>);
			}
        <?php } ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo form_open_multipart("rentals/add_room_blocking", $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['rentals-date']) { ?>
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    <div class="col-md-4">
                                        <div class="form-group" style="margin-bottom:10px;">
                                            <?= lang("customer", "rtbcustomer"); ?>
                                            <div class="input-group">
                                                <?php
													echo form_input('customer', (isset($_POST['customer']) ? $_POST['customer'] : ""), 'id="rtbcustomer" valuedata-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("customer") . '" required="required" class="form-control input-tip" style="width:100%;"');
                                                ?>
						...
						<div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php $st = array('reservation' => lang('reservation'), 'checked_in' => lang('checked_in'));
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		function floor(e){
			...
			var customer_id = $('#rtbcustomer').val();
            var frequency = $("#rtfrequency").val();
            var from_date = $("#rtfrom_date").val().split("/");
			...
			$.ajax({
                type: "get",
                url: "<?=site_url('rentals/get_room_floor_reservation')?>",
                data: { from_date: from_date, floor_id: floor_id, room_id : room_id },
                dataType: "json",
                success: function (data) {
                    if(data){
