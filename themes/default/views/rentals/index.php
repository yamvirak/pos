...
<script type="text/javascript">
    $(document).ready(function () {
		oTable = $('#table_rentals').dataTable({
			...
			'sAjaxSource': '<?= site_url('rentals/getRentals/'.($warehouse ? $warehouse->id : 0).'/'.($biller ? $biller->id : 0).'/'.($payment_status ? $payment_status : '')); ?>',
...
<div class="box">
	<div class="box-header box-header">
       <div class="action-header"> 
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <h2 class="blue"><i class="fa-fw fa fa-bed"></i><?= lang('rentals'); ?></h2>
