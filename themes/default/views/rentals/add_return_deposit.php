...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_return_deposit'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
            echo form_open_multipart("rentals/add_return_deposit/" . $rental->id, $attrib);
            $return_amount = (double)$deposit->amount - (double)$deposit_sale->amount - (double)$return_deposit->amount; 
		?>
        <div class="modal-body">
            ...
            <div class="row">
               <?php if ($Owner || $Admin || $GP['rentals-date']) { ?>
                ...
                <input type="hidden" value="<?php echo $rental->id; ?>" name="rental_id"/>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
							...
							<?php foreach($currencies as $currency){ 
									...
									$base_amount = (double)$return_amount / $base_currency->rate;
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_return_deposit', lang('add_return_deposit'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
