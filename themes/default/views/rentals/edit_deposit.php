...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("rentals/edit_deposit/" . $deposit->id, $attrib); ?>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <input type="hidden" value="<?php echo $deposit->transaction_id; ?>" name="rental_id"/>
            </div>
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
		...
		$(".c_amount").on("change",function(){
			var amount = $(this).val();
			var interest = (("<?= $deposit->interest_paid; ?>") * 100) / ("<?= ($deposit->amount + $deposit->interest_paid); ?>");
			var principal = (("<?= $deposit->amount; ?>") * 100) / ("<?= ($deposit->amount + $deposit->interest_paid); ?>");
