<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_room'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("rentals_housekeeping/add_room_housekeeping", $attrib); ?>
                ...
                <div class="col-md-6">
					<div class="form-group">
						...
						<?php
							...
							echo form_dropdown('product_id', $pd, (isset($_POST['product_id']) ? $_POST['product_id'] : ''), 'id="product_id" required="required" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("product") . '" style="width:100%;" ');
						?>
                    </div>
                </div>
                <div class="col-md-6">
                        <div class="form-group">
                            <?= lang("price", "price"); ?>
                            <?php echo form_input('price', (isset($_POST['price']) ? $_POST['price'] :''), 'class="form-control input-tip bold" id="price" name="price" readonly'); ?>
                        </div>
                </div>
                <div class="col-md-6">
					<div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
						...
						<?php
							...
							echo form_dropdown('bed_number', $bn, (isset($_POST['bed_number']) ? $_POST['bed_number'] : ''), 'id="bed_number" class="form-control select" data-placeholder="' . lang("select") . ' ' . lang("bed_number") . '" required="required" style="width:100%;" ');
						?>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
						...
						<?php
							...
							echo form_dropdown('status', $st, (isset($_POST['status']) ? $_POST['status'] : ''), 'id="status" class="form-control select"  style="width:100%;"');
						?>
                    </div>
				</div>
			</div>
		...
		<div class="modal-footer">
			<?php echo form_submit('add_room_housekeeping', lang('add_room_housekeeping'), 'class="btn btn-primary"'); ?>
		</div>
	</div>
	</div>
