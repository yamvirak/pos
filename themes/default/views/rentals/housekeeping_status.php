...
<script>
    $(document).ready(function () {
        var oTable = $('#TaData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('rentals_configuration/getHousekeepingStatus') ?>',
            ...
            {column_number: 3, filter_default_label: "[<?=lang('color');?>]", filter_type: "text", data: []},
...
<?php if ($Owner) {
    echo form_open('rentals_configuration/housekeeping_status_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header box-header">
       <div class="action-header"> 
            <a href="<?php echo site_url('rentals_configuration/add_housekeeping_status'); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <h2 class="blue"><i class="fa fa-inbox"></i><?= lang('housekeeping_status'); ?></h2>
                ...
                <div class="table-responsive">
                    <table id="TaData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th style="width:50px; text-align: center;"><?= lang("color"); ?></th>
