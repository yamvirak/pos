...
<script type="text/javascript">
    $(document).ready(function () {
		oTable = $('#table_rentals').dataTable({
			...
			'sAjaxSource': '<?= site_url('rentals_check_in/getCheckIn/'.($warehouse ? $warehouse->id : 0).'/'.($biller ? $biller->id : 0).'/'.($payment_status ? $payment_status : '')); ?>',
...
<div class="box">
	...
	<div class="box-header box-header">
		<div class="action-header"> 
            <a href="<?php echo site_url('rentals_check_in/add'); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal">
