...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (localStorage.getItem('rtstart_date')) {
            localStorage.removeItem('rtstart_date');
        }
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_rental'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo form_open_multipart("rentals/add", $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['rentals-date']) { ?>
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('sources', $src, (isset($_POST['sources']) ? $_POST['sources'] : ''), 'id="sources" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("sources") . '" required="required" style="width:100%;" ');
                                            ?>
                                        </div>
                                    </div>
									<div class="col-md-4">
						...
						<div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php $st = array('reservation' => lang('reservation'));
                                echo form_dropdown('status', $st, 'reservation', 'class="form-control input-tip" id="rtstatus"'); ?>
                            </div>
                        </div>
                    ...
                    <?php if ($Settings->tax1) { ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php
                                $trv[""] = "";
                                foreach ($tax_validations as $tax_validation) {
                                    $trv[$tax_validation->id] = $tax_validation->name;
                                }
                                echo form_dropdown('ptax', $trv, "", 'id="ptax" class="form-control pos-input-tip" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                    <?php } ?>
...
<script type="text/javascript">
    ...
    $("#rtstart_date").datetimepicker({
		...
		function room_type(e){
			...
			$.ajax({
                type: "get",
                url: "<?=site_url('rentals/get_room_type_reservation')?>",
