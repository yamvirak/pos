...
<script type="text/javascript">
    $(document).ready(function () {
		oTable = $('#table_rentals').dataTable({
			...
			'sAjaxSource': '<?= site_url('rentals/getCancelledReservationList/'.($warehouse ? $warehouse->id : 0).'/'.($biller ? $biller->id : 0).'/'.($payment_status ? $payment_status : '')); ?>',
			...
			{column_number: 5, filter_default_label: "[<?=lang('room');?>]", filter_type: "text", data: []},
...
<div class="box">
	...
	<div class="box-header box-header">
       <div class="action-header"> 
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <h2 class="blue"><i class="fa-fw fa fa-bed"></i><?= lang('cancelled_reservation_list'); ?></h2>
                    ...
                    <table id="table_rentals" cellpadding="0" cellspacing="0" border="0"
						...
						<thead>
							<tr class="primary">
								...
								<th style="width:50px;"><?= lang("remark"); ?></th>
