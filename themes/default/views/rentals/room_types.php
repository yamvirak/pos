<script>
    $(document).ready(function () {
        var oTable = $('#TaData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('rentals_configuration/getRoomTypes') ?>',
...
<?php if ($Owner) {
    echo form_open('rentals_configuration/room_type_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header box-header">
       <div class="action-header"> 
            <a href="<?php echo site_url('rentals_configuration/add_room_type'); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <h2 class="blue"><i class="fa fa-inbox"></i><?= lang('room_type'); ?></h2>
