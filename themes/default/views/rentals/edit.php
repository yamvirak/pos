...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        <?php } ?>
         ...
         <?php if($service_type){ ?>
            localStorage.setItem('rtservicetypes', '<?= $service_type ?>');
        <?php } ?>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('edit_rental'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
                $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'class' => 'edit-rt-form');
                echo form_open_multipart("rentals/edit/" . $id, $attrib)
                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control input-tip" id="rtref" '); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-warning">
                                <div
                                    class="panel-heading"><?= lang('please_select_these_before_adding_service') ?></div>
                                <div class="panel-body" style="padding: 5px;">
                                    <div class="col-md-4">
                                        <div class="form-group" style="margin-bottom:10px;">
                                            <?= lang("customer", "rtcustomer"); ?>
                                            <div class="input-group">
                                                <?php
													echo form_input('customer', (isset($_POST['customer']) ? $_POST['customer'] : ""), 'id="rtcustomer" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("customer") . '" required="required" class="form-control input-tip" style="width:100%;"');
                                                ?>
                                                <div class="input-group-addon no-print" style="padding: 2px 8px; border-left: 0;">
                                                    <a href="#" id="toogle-customer-read-attr" class="external">
                                                        <i class="fa fa-unlock" id="addIcon" style="font-size: 1.2em;"></i>
                                                    </a>
                                                </div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $inv->warehouse_id), 'id="rtwarehouse" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . '" required="required" style="width:100%;" ');
											?>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<?php
											$src[''] = lang('select').' '.lang('sources');
											if($sources){
												foreach ($sources as $source) {
													$src[$source->id] = $source->name;
												}
											}
											echo form_dropdown('sources', $src, (isset($_POST['sources']) ? $_POST['sources'] : $inv->source_id), 'id="sources" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("sources") . '" required="required" style="width:100%;" ');
											?>
										</div>
									</div>
									...
									<div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="no-room_type">
                                                ...
                                                echo form_dropdown('room_type', $room_tp, $inv->room_type_id, 'id="room_type" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("room_type") . '" style="width:100%;" ');
                                                ?>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group">
												<?php echo form_input('from_date', (isset($_POST['from_date']) ? $_POST['from_date'] : ""), 'class="form-control input-tip date" id="rtfrom_date" required="required"'); ?>
												<div class="input-group-addon no-print" style="padding: 2px 7px; border-left: 0;">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="input-group">
												<?php echo form_input('to_date', (isset($_POST['to_date']) ? $_POST['to_date'] : ""), 'class="form-control input-tip date" id="rtto_date" required="required"'); ?>
												<div class="input-group-addon no-print" style="padding: 2px 7px; border-left: 0;">
													<i class="fa fa-calendar" aria-hidden="true"></i>
												</div>
											</div>
									...
									<div class="col-md-2">
										<div class="form-group">
											<?= lang("adult", "adult"); ?>
											<div class="input-group">
												<input name="adult" type="number" id="adult" min="0" class="form-control" placeholder="1" value="<?= set_value("adult", $inv->adult);?>" />
												<div class="input-group-addon no-print" style="padding: 2px 7px; border-left: 0;">
									...
									<div class="col-md-2">
										<div class="form-group">
											<?= lang("kid", "kid"); ?>
											<div class="input-group">
												<input name="kid" type="number" id="kid" min="0" class="form-control" placeholder="0" value="<?= set_value("kid", $inv->kid);?>"/>
												<div class="input-group-addon no-print" style="padding: 2px 7px; border-left: 0;">
													<i class="fa fa-users" aria-hidden="true"></i>
												</div>
											</div>
						...
						<div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php $st = array('checked_in' => lang('checked_in'),'reservation' => lang('reservation'), 'cancelled' => lang('cancelled'),'maintenance' => lang('maintenance'));
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('discount', '', 'class="form-control input-tip" id="rtdiscount" '.(($Owner || $Admin || $this->session->userdata('allow_discount')) ? '' : 'readonly="true"')); ?>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col-sm-12">
                            <div
                                class="fprom-group"><?php echo form_submit('edit_rental', $this->lang->line("submit"), 'id="edit_rental" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
...
<script type="text/javascript">
	$(function(){
		...
		$("#room_type").on("change", room_type); floor();
		function floor(){
            ...
            <?php } else {?>
                var customer_id = $('#rtcustomer').val();
		...
		$("#rtfrequency, #rtfrom_date").on("change",function(){
