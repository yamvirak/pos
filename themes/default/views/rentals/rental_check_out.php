...
<script type="text/javascript">
    $(document).ready(function () {
		oTable = $('#table_rentals').dataTable({
			...
			'sAjaxSource': '<?= site_url('rentals/getRentalCheckOut/'.($warehouse ? $warehouse->id : 0).'/'.($biller ? $biller->id : 0).'/'.($payment_status ? $payment_status : '')); ?>',
			...
			{column_number: 5, filter_default_label: "[<?=lang('room_number');?>]", filter_type: "text", data: []},
			{column_number: 6, filter_default_label: "[<?=lang('from_date');?>]", filter_type: "text", data: []},
            {column_number: 7, filter_default_label: "[<?=lang('to_date');?>]", filter_type: "text", data: []},
			{column_number: 10, filter_default_label: "[<?=lang('checked_out_date');?>]", filter_type: "text", data: []},
	...
	<div class="box-header box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
				...
				<?php } ?>
                <h2 class="blue"><i class="fa fa-bed"></i><?= lang('checked_out_list'); ?></h2>
