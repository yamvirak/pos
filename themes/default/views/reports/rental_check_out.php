...
<script>
    $(document).ready(function () {
        oTable = $('#RentalData').dataTable({
			...
			'sAjaxSource': '<?= site_url('reports/getRentalsCheckOutReport/?v=1'.$v); ?>',
...
<div class="box">
    <div class="box-header">
        <!-- <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('rental_check_out_report'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="sub_menu">
            <a href="javascript:;" onclick="window.print();" id ="print" class="tip btn btn-success btn-block box_sub_menu" title="<?= lang('print') ?>">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-dollar tip"></i><?= lang('rental_check_out_report'); ?></h2>
                </li>
                <!-- <li class="dropdown">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo form_open("reports/rental_check_out"); ?>
                    <div class="row">
						...
						<div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php
                                $st = array(''=>lang('select').' '.lang('status'), 'checked_out'=>lang('checked_out'));
                        ...
                        <td class="text_center" style="width:100%">
                            ...
                            <br>
                                ...
                                <div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">
                                        <?= lang('rental_check_out_report_kh')?>
                                </div> 
                                <div class="bold">
                                        <?= lang('rental_check_out_report_en')?>
                                </div><br>
                    ...
                    <table id="RentalData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                         <tr class="primary">
								...
								<th style="width:150px;"><?= lang("from_date"); ?></th>
								<th style="width:150px;"><?= lang("to_date"); ?></th>
