...
<script type="text/javascript">
    $(document).ready(function () {
        oTable = $('#PoRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getPurchasesFreightReport/?v=1' . $v) ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                nRow.id = aData[13];
                nRow.className = (aData[7] > 0) ? "purchase_link2 warning" : "purchase_link2";
                return nRow;
            },
            "aoColumns": [{"mRender": fld}, null, null, null,null,null,null, {
                "bSearchable": false,
                "mRender": pqFormat
            }, {"mRender": currencyFormat},{"mRender": currencyFormat}, {"mRender": currencyFormat},{"mRender": pay_status},{"bSortable": false,"mRender": attachment}],
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/purchase_freight"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <table id="PoRData"
                        ...
                        <tr>
                            ...
                            <th><?= lang("reference_no"); ?></th>
                             <th><?= lang("purchase_reference_no"); ?></th>
							<th><?= lang("biller"); ?></th>
							<th><?= lang("project"); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getPurchasesFreightReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getPurchasesFreightReport/0/xls/?v=1'.$v)?>";
            return false;
        });
...
<style type="text/css">
	...
	<?php } ?>
			#PoRData th:nth-child(7), #PoRData td:nth-child(7){
			display:none !important;
		}
