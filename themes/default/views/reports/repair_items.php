...
<script>
    $(document).ready(function () {
        oTable = $('#RepairItems').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getRepairItemsReport/?v=1' . $v); ?>',
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getRepairItemsReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getRepairItemsReport/0/xls/?v=1'.$v)?>";
            return false;
        });
