...
<script>
    $(document).ready(function () {
        oTable = $('#DNDData').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('reports/getDeliveryDetailReport/?v=1' . $v); ?>',
...
<div class="box">
    <div class="box-header">
        <!-- <h2 class="blue"><i class="fa-fw fa fa-filter"></i><?= lang('delivery_details_report'); ?><?php
            if ($this->input->post('start_date')) {
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-truck tip"></i><?= lang('deliveries_detail_report'); ?></h2>
                </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/delivery_details"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <?php 
                                ...
                                <?php 
                                    ...
                                    if($sale_type_id == 1){
                                        ...
                                        echo '<div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">'.lang('deliveries_detail_report_kh').'</div>';
                                        echo '<div class="bold">'.lang('deliveries_detail_report_en').'</div><br>';
                                }
                ...
                <div class="table-responsive">
                    <table id="DNDData" class="table table-bordered table-condensed table-hover table-striped">
                        <thead>
                        <tr>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getDeliveryDetailReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getDeliveryDetailReport/0/xls/?v=1'.$v)?>";
            return false;
        });
