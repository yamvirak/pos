...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#adjustmentDetailData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getProductsFreeReport/?v=1' . $v); ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-filter"></i><?= lang('products_free_report'); ?><?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/products_free_report"); ?>
                    <div class="row">
						<div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getProductsFreeReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getProductsFreeReport/0/xls/?v=1'.$v)?>";
            return false;
        });
