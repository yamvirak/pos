...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getProductVariantReport/?v=1'.$v) ?>',
			...
			{column_number: 2, filter_default_label: "[<?=lang('varaint');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('product_variant'); ?> <?php
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/product_variant"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getProductVariantReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getProductVariantReport/0/xls/?v=1'.$v)?>";
            return false;
        });
