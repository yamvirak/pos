...
<script>
    $(document).ready(function () {
        oTable = $('#CusData').dataTable({
            ...
            "aoColumns": [{"mRender" : checkbox},null, null, null, null, {
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                if (isset($warehouses) && $warehouses != false) {
						...
						<div class="col-sm-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('created_by', $us, (isset($_POST['created_by']) ? $_POST['created_by'] : ""), 'class="form-control" id="created_by" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("user") . '"');
                                ?>
                            </div>
                        </div>
							...
							<td class="text_center" style="width:100%">
								...
								<?php 
									...
									if($sale_type_id == 1){
										...
										echo '<div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">'.lang('suppliers_report_kh').'</div>';
										echo '<div class="bold">'.lang('suppliers_report_en').'</div><br>';
								}
								?>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#print').click(function (event) {
			var supplier = $(this).attr("window");
            event.preventDefault();
			if($('.multi-select:checked').length <= 0){
				bootbox.alert("Please select checkbox first.");
				return false;
			}
            window.location.href = "<?=site_url('reports/print_supplier_purchases/?v=1' . $v)?>"+"&supplier="+supplier;
            return false;
        });
