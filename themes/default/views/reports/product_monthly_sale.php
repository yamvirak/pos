...
<script>
    $(document).ready(function () {
        oTable = $('#PrMonlyRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getProductsMontlySale/?v=1'.$v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('product_monthly_sale'); ?> 
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/product_monthly_sale"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getProductsMontlySale/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getProductsMontlySale/0/xls/?v=1'.$v)?>";
            return false;
        });
