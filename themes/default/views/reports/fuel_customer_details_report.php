...
<style type="text/css" media="screen">
	<?php if($this->config->item("customer_truck") != true) { ?>
		#FCustomerDData td:nth-child(6) {
			display: none !important;
		}
		#FCustomerDData th:nth-child(6) {
			display: none !important;
		}
	<?php } ?>
</style>
...
<script>
    $(document).ready(function () {
        oTable = $('#FCustomerDData').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('reports/getFuelCustomerDetailsReport/?v=1' . $v); ?>',
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                nCells[7].innerHTML = formatQuantity(quantity);
			...
			{column_number: 5, filter_default_label: "[<?=lang('truck');?>]", filter_type: "text", data: []},
			{column_number: 6, filter_default_label: "[<?=lang('product');?>]", filter_type: "text", data: []},
			{column_number: 8, filter_default_label: "[<?=lang('unit_price');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('fuel_customer_details_report'); ?> <?php
            if ($this->input->post('start_date')) {
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo form_open("reports/fuel_customer_details_report"); ?>
                    <div class="row">
						<div class="col-sm-4">
                ...
                <div class="table-responsive">
                    <table id="FCustomerDData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
                        <thead>
                        <tr class="active">
							...
							<th style="width:100px;"><?= lang("truck"); ?></th>
							<th style="width:100px;"><?= lang("product"); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getFuelCustomerDetailsReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getFuelCustomerDetailsReport/0/xls/?v=1'.$v)?>";
            return false;
        });
