...
if ($this->input->post('purchase_tax')) {
    $v .= "&purchase_tax=" . $this->input->post('purchase_tax');
}
...
<script type="text/javascript">
    $(document).ready(function () {
        oTable = $('#PoRData').dataTable({
            ...
            "aoColumns": [{"mRender": checkbox, "bVisible":false}, {"mRender": fld},null, {
                "bSearchable": false,
                "mRender": pqFormat
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/convert_report"); ?>
                    <div class="row">
                        <div class="col-sm-4">
