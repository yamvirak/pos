...
<script>
    $(document).ready(function () {
        oTable = $('#consignmentData').dataTable({
            "aaSorting": [[12, "desc"],[1, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('reports/getConsignmentDetailReport/?v=1' . $v); ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="fa-fw fa fa-filter"></i><?= lang('consignment_details_report'); ?><?php
                        if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/consignment_details"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <?php 
                                ...
                                <?php 
                                    ...
                                    if($sale_type_id == 1){
                                        ...
                                        echo '<div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">'.lang('consignment_details_report_kh').'</div>';
                                        echo '<div class="bold">'.lang('consignment_details_report_en').'</div><br>';
                                }
                ...
                <div class="table-responsive">
                    <table id="consignmentData" class="table table-bordered table-condensed table-hover table-striped">
                        <thead>
                        <tr>
							...
							<th class="col-xs-1"><?= lang("total_qty"); ?></th>
							<th class="col-xs-1"><?= lang("return_qty"); ?></th>
							<th class="col-xs-1"><?= lang("sale_qty"); ?></th>
							<th class="col-xs-1"><?= lang("balance"); ?></th>
							<th style="max-width:30px"><?= lang("status"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getConsignmentDetailReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getConsignmentDetailReport/0/xls/?v=1'.$v)?>";
            return false;
        });
