...
<script>
    $(document).ready(function () {
        oTable = $('#PayRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getPrintHistory/?v=1' . $v) ?>',
            ...
            "aoColumns": [{"mRender": fld, "sClass":"center"},
			{"sClass":"center"},
			{"sClass":"center"},
			{"sClass":"center"}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-money"></i><?= lang('print_history'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/print_history"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getprint_history/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getprint_history/0/xls/?v=1'.$v)?>";
            return false;
        });
