...
<div class="box">
    <div class="box-header">
        <!-- <h2 class="blue"><i class="fa-fw fa fa-money"></i><?= lang('rental_payments_report'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-money tip"></i><?= lang('rental_payments_report'); ?></h2>
                </li>
                    ...
                    <th>
                        <tr> 
                                ...
                                <div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">
                                        <?= lang('rental_payments_report_kh')?>
                                </div> 
                                <div class="bold">
                                        <?= lang('rental_payments_report_en')?>
                                </div><br>
                            </td> 
                        </tr>
                </table>
