...
<div id="print-box">
	...
	<?php if(isset($_GET['v']) && trim($_GET['v'])==2){ ?>
		<a href="<?= site_url("reports/customer_report/".trim($_GET['customer'])); ?>" class="btn btn-xs btn-default no-print pull-right" style="margin-right:15px;">
...
<?php
    ...
    $customers = explode(",",$_GET['customer']);
    foreach($customers as $cust){
        $rows = $this->reports_model->getSaleReportByCustomers($cust);
		$customer = $this->site->getCompanyByID($cust);
?>
<div id="wrap">
	<div id="paper">
		<div class="row">
						...
						<td colspan="7" style="border:none;">
							<div class="cover-head">
								...
								<div class="col-sm-12 text-center" style="margin-bottom:8px;">
									<h4 style="font-weight:bold; text-decoration:underline;"><?=lang('customer_sales_report');?></h4>
								</div>
								
								<table width="100%">
									<tr>
										<th style="border:none; text-align:left;">
											<span style='color:#357EDD !important;'><?= lang("customer") ?> : <?= ($customer->company && $customer->company != '-' ? $customer->company : $customer->name) ?></span>
										</th>
									</tr>
									<tr>
										<th style="border:none; text-align:left;">
											<span style='color:#357EDD !important;'><?= lang("phone") ?> : <?= $customer->phone; ?></span>
										</th>
									</tr>
									<tr>
										<th style="border:none; text-align:left;">
						...
						<tbody>
							<?php 
								...
								<tr>
									...
									<td style="text-align:left"><?= $data_row->customer; ?></td>
