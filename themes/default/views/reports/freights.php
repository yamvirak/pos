...
if ($this->input->post('freight_tax')) {
    $v .= "&freight_tax=" . $this->input->post('freight_tax');
}
...
<script type="text/javascript">
    $(document).ready(function () {
        oTable = $('#FreightRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getFreightReports/?v=1' . $v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star"></i><?= lang('freights_report'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/freights"); ?>
                    <div class="row">
                        <div class="col-sm-4">
						...
						<div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="freight_tax"><?= lang("freight_tax"); ?></label>
                                <?php
                                $stax[""] = lang('select').' '.lang('freight_tax');
                                $stax["yes"] = lang('yes');
								$stax["no"] = lang('no');
                                echo form_dropdown('freight_tax', $stax, (isset($_POST['freight_tax']) ? $_POST['freight_tax'] : ""), 'class="form-control" id="freight_tax" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("freight_tax") . '"');
                                ?>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table id="FreightRData" class="table table-bordered table-hover table-striped table-condensed reports-table">
                        <thead>
							<tr>
								<th><?= lang("date"); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getFreightReports/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getFreightReports/0/xls/?v=1'.$v)?>";
            return false;
        });
...
<style type="text/css">
	<?php if(!$Settings->project){ ?>
		#FreightRData th:nth-child(4), #FreightRData td:nth-child(4){
