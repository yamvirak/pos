        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="small-box padding1010 col-sm-4 bblue">
                    <h3 class="bold"><?= isset($sales->total_amount) ? $this->cus->formatMoney($sales->total_amount) : '0.00' ?></h3>

                    <p class="bold"><?= $sales->total . ' ' . lang('sales') ?></p>
                </div>
                <div class="small-box padding1010 col-sm-4 bdarkGreen">
                    <h3><?= isset($sales->paid) ? $this->cus->formatMoney($sales->paid) : '0.00' ?></h3>

                    <p><?= lang('total_paid') ?></p>
                </div>
                <div class="small-box padding1010 col-sm-4 borange">
                    <h3><?= (isset($sales->total_amount) || isset($sales->paid)) ? $this->cus->formatMoney($sales->total_amount - $sales->paid) : '0.00' ?></h3>
            ...
            <div class="col-sm-6">
                <div class="small-box padding1010 col-sm-4 bblue">
                    <h3 class="bold"><?= isset($purchases->total_amount) ? $this->cus->formatMoney($purchases->total_amount) : '0.00' ?></h3>
                                ...
                                <tr>
                                    ...
                                    if (!empty($msales)) {
                                        ...
                                        foreach ($msales as $value) {
                                            $array[$value->date] = "<table class='table table-bordered table-hover table-striped table-condensed reports-table data' style='margin:0;'><tr><td>" . lang("discount") . "</td></tr><tr><td>" . $this->cus->formatMoney($value->discount) . "</td></tr><tr><td>" . lang("product_tax") . "</td></tr><tr><td>" . $this->cus->formatMoney($value->tax1) . "</td></tr><tr><td>" . lang("order_tax") . "</td></tr><tr><td>" . $this->cus->formatMoney($value->tax2) . "</td></tr><tr><td>" . lang("total") . "</td></tr><tr><td>" . $this->cus->formatMoney($value->total) . "</td></tr></table>";
                                        }
                ...
                oTable = $('#SlRData').dataTable({
                    ...
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        ...
                        for (var i = 0; i < aaData.length; i++) {
							...
							greturn += parseFloat(aaData[aiDisplay[i]][4]);
            ...
            $(document).ready(function () {
                oTable = $('#PoRData').dataTable({
                   ...
                   "aoColumns": [{"mRender": checkbox, "bVisible":false}, {"mRender": fld}, null, null, null,null,null, {
					"bSearchable": false,
					"mRender": pqFormat
				}, {"mRender": currencyFormat},{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status},{"mRender": pay_status}],
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
        ...
        <script>
            $(document).ready(function () {
                ...
                oTable = $('#PayRData').dataTable({
                    ...
                    "aoColumns": [{"mRender": fld}, null, null, null,{"mRender": fld}, {"mRender": paid_by}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}],
                    'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                        nRow.id = aData[9];
