            ...
            <table width="100%" class="stable">
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;">
                            <h4><span><?= $this->cus->formatMoney($costing->sales); ?></span></h4>
                            <!-- <h4><span><?= $this->cus->formatMoney($costing->sales).' ('.$this->cus->formatMoney($costing->net_sales).')'; ?></span></h4>-->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;">
                        <h4><span><?= $this->cus->formatMoney($costing->cost); ?></span></h4>
                        <!-- <h4><span><?= $this->cus->formatMoney($costing->cost).' ('.$this->cus->formatMoney($costing->net_cost).')'; ?></span></h4> -->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <h4>
                            ...
                            <!-- <span><strong><?= $this->cus->formatMoney($costing->sales - $costing->cost - $discount - $expense).' ('.$this->cus->formatMoney($costing->net_sales - $costing->net_cost - $discount - $expense).')'; ?></strong></span> -->
                        </h4>
                    </td>
                </tr>
            </table>
