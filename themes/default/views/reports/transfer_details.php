...
<script>
    $(document).ready(function () {
        oTable = $('#dmpData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getTransferDetailReport/?v=1' . $v); ?>',
...
<div class="box">
    ...
    <div class="sub_menu"></div>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="fa-fw fa fa-filter icon"></i><?= lang('transfer_details_report'); ?><?php
                        if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/transfer_details"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <?php 
                                ...
                                <?php 
                                    ...
                                    if($sale_type_id == 1){
                                        ...
                                        echo '<div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">'.lang('transfer_details_report_kh').'</div>';
                                        echo '<div class="bold">'.lang('transfer_details_report_en').'</div><br>';
                                }
                ...
                <div class="table-responsive">
                    <table id="dmpData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr>
							...
							<th class="col-xs-1"><?= lang("warehouse") . ' (' . lang('from') . ')'; ?></th>
                            <th class="col-xs-1"><?= lang("warehouse") . ' (' . lang('to') . ')'; ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getTransferDetailReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getTransferDetailReport/0/xls/?v=1'.$v)?>";
            return false;
        });
