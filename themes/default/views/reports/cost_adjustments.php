...
<script>
    $(document).ready(function () {
        oTable = $('#dmpData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getCostAdjustmentReport/?v=1' . $v); ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                nRow.id = aData[6];
                nRow.className = "cost_adjustment_link2";
                return nRow;
            },
...
<div class="box">
    <div class="box-header">
        <!-- <h2 class="blue"><i class="fa-fw fa fa-filter"></i><?= lang('cost_adjustments_report'); ?><?php
            if ($this->input->post('start_date')) {
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-filter tip"></i><?= lang('cost_adjustments_report'); ?></h2>
                </li>
                <!-- <li class="dropdown">
                ...
                <li class="dropdown">
                    <a href="#" id="excel" class="tip" title="<?= lang('download_xls') ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/cost_adjustments"); ?>
                    <div class="row">
                        <div class="col-sm-4">
							...
							<td class="text_center" style="width:100%">
								...
								<?php 
									...
									if($sale_type_id == 1){
										...
										echo '<div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">'.lang('cost_adjustments_report_kh').'</div>';
										echo '<div class="bold">'.lang('cost_adjustments_report_en').'</div><br>';
								}
								?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getCostAdjustmentReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getCostAdjustmentReport/0/xls/?v=1'.$v)?>";
            return false;
        });
