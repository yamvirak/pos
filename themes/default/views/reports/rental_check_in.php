...
<script>
    $(document).ready(function () {
        oTable = $('#RentalData').dataTable({
			...
			'sAjaxSource': '<?= site_url('reports/getRentalsCheckInReport/?v=1'.$v); ?>',
...
<div class="box">
    <div class="box-header">
        <!-- <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('rental_check_in_report'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="sub_menu">
            <a href="#" class="toggle_down tip btn btn-info btn-block box_sub_menu" title="<?= lang('show_form') ?>">
                <i class="icon fa fa-toggle-down"></i>&nbsp;</i><?=lang('show_form')?>
            </a>
        </div>
        <div class="sub_menu">
            <a href="#" class="toggle_up tip btn btn-danger btn-block box_sub_menu" title="<?= lang('hide_form') ?>">
                <i class="icon fa fa-toggle-up"></i>&nbsp;</i><?=lang('hide_form')?>
            </a>
        </div>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-dollar tip"></i><?= lang('rental_check_in_report'); ?></h2>
                </li>
                <!-- <li class="dropdown">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    <?php echo form_open("reports/rental_check_in"); ?>
                    <div class="row">
                        ...
                        <td class="text_center" style="width:100%">
                            ...
                            <br>
                                ...
                                <div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">
                                        <?= lang('rental_check_in_report_kh')?>
                                </div> 
                                <div class="bold">
                                        <?= lang('rental_check_in_report_en')?>
                                </div><br>
