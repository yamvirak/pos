...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#registerTable1').dataTable({
            ...
            "aoColumns": [{"mRender": checkbox}, {"mRender": fld}, {"mRender": fld}, null, {"mRender": currencyFormat}, {"mRender": total_cash}, {"bSortable": false}, {"mRender": formatQuantity}]
            ...
            {column_number: 5, filter_default_label: "[<?=lang('total_cash');?>]", filter_type: "text", data: []},
