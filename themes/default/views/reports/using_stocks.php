...
<script>
    $(document).ready(function () {
        oTable = $('#usingData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getUsingStockReport/?v=1' . $v); ?>',
            ...
            {column_number: 4, filter_default_label: "[<?=lang('using_by')?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <!-- <h2 class="blue"><i class="fa-fw fa fa-filter"></i><?= lang('using_stocks_report'); ?><?php
            if ($this->input->post('start_date')) {
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-filter tip"></i><?= lang('using_stocks_report'); ?></h2>
                </li>
                <!-- <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/using_stocks"); ?>
                    <div class="row">
                        <div class="col-sm-4">
							...
							<td class="text_center" style="width:100%">
								...
								<?php 
									...
									if($sale_type_id == 1){
										...
										echo '<div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">'.lang('using_stocks_report_kh').'</div>';
										echo '<div class="bold">'.lang('using_stocks_report_en').'</div><br>';
								}
								?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getUsingStockReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getUsingStockReport/0/xls/?v=1'.$v)?>";
            return false;
        });
