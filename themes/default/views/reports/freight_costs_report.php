...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#EXPData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getFreightCost/?v=1' . $v); ?>',
            ...
            {column_number: 4, filter_default_label: "[<?=lang('purchase_cost');?>]", filter_type: "text", data: []},
			{column_number: 5, filter_default_label: "[<?=lang('freight_cost');?>]", filter_type: "text", data: []},
			{column_number: 6, filter_default_label: "[<?=lang('total_cost');?>]", filter_type: "text", data: []},
        ], "footer");
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('freight_costs_report'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/freight_costs_report"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                ...
                <div class="table-responsive">
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th class="col-xs-1"><?= lang("purchase_cost"); ?></th>
							<th class="col-xs-1"><?= lang("freight_cost"); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getFreightCost/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getFreightCost/0/xls/?v=1'.$v)?>";
            return false;
        });
