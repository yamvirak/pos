...
<script>
    $(document).ready(function () {
        oTable = $('#SARData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getSalemanReports/?v=1' . $v) ?>',
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
					total_sale += parseFloat(aaData[aiDisplay[i]][5]);
				...
				nCells[5].innerHTML = parseFloat(total_sale);
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('saleman_report'); ?> <?php
            if ($this->input->post('start_date')) {
		...
		<div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/saleman_report"); ?>
...
<script type="text/javascript">
	$(function(){
		...
		$('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getSalemanReports/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getSalemanReports/0/xls/?v=1'.$v)?>";
            return false;
        });
