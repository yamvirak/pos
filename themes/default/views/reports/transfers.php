...
<script>
    $(document).ready(function () {
        oTable = $('#dmpData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getTransferReport/?v=1' . $v); ?>',
			...
			{column_number: 7, filter_default_label: "[<?=lang('products')?>]", filter_type: "text", data: []},
...
<div class="box">
    ...
    <div class="sub_menu"></div>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="fa-fw fa fa-filter icon"></i><?= lang('transfers_report'); ?><?php
                        if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/transfers"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="warehouse"><?= lang("warehouse") . ' (' . lang('from') . ')'; ?></label>
                                <?php
						...
						<div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="to_warehouse"><?= lang("warehouse") . ' (' . lang('to') . ')'; ?></label>
                                <?php
                                echo form_dropdown('to_warehouse', $wh, (isset($_POST['to_warehouse']) ? $_POST['to_warehouse'] : ""), 'class="form-control" id="to_warehouse" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("warehouse") . '"');
                                ?>
                            </div>
                        </div>
                            ...
                            <?php 
                                ...
                                <?php 
                                    ...
                                    if($sale_type_id == 1){
                                        ...
                                        echo '<div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">'.lang('transfer_report_kh').'</div>';
                                        echo '<div class="bold">'.lang('transfer_report_en').'</div><br>';
                                }
                ...
                <div class="table-responsive">
                    <table id="dmpData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr>
							...
							<th class="col-xs-2"><?= lang("warehouse") . ' (' . lang('from') . ')'; ?></th>
                            <th class="col-xs-2"><?= lang("warehouse") . ' (' . lang('to') . ')'; ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getTransferReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getTransferReport/0/xls/?v=1'.$v)?>";
            return false;
        });
