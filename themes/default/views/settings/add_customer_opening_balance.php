...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_customer_opening_balance'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("system_settings/add_customer_opening_balance", $attrib); ?>
        <div class="modal-body">
			...
			<div class="form-group">
                ...
                ?>
                <?= form_dropdown('customer', $ct, set_value('customer'), 'class="form-control tip" required id="customer"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_customer_opening_balance', lang('add_customer_opening_balance'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
