...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#EXPData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getSupplierOpeningBalances/'.($biller ? $biller->id : '')); ?>',
...
<?php if ($Owner || $GP['bulk_actions']) {
        echo form_open('system_settings/supplier_opening_balance_actions', 'id="action-form"');
    }
?>
<div class="box">
    <div class="box-header">
        ...
        <div class="sub_menu">
            <a href="<?= site_url('system_settings/add_supplier_opening_balance') ?>" data-toggle="modal" 
        ...
        <div class="sub_menu">
            <a href="<?php echo site_url('system_settings/add_supplier_opening_balance_excel/'); ?>" 
        ...
        <div class="sub_menu">
            <a href="#" class="bpo btn btn-danger btn-block box_sub_menu" tabindex="-1"
                title="<b><?= $this->lang->line("delete_supplier_opening_balances") ?></b>" 
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-dollar tip"></i><?= lang('supplier_opening_balances'); ?></h2>
                </li>
                <?php if (!empty($billers) && $this->config->item('one_biller')==false) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= site_url('system_settings/supplier_opening_balances') ?>"><i class="fa fa-industry"></i> <?= lang('all_billers') ?></a></li>
                            <li class="divider"></li>
                            <?php
                            foreach ($billers as $biller) {
                                echo '<li><a href="' . site_url('system_settings/supplier_opening_balances/'.$biller->id) . '"><i class="fa fa-home"></i>' . $biller->name . '</a></li>';
                            }
                            ?>
                        </ul>
                    </liv>
