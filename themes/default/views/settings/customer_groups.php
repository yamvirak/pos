...
<div class="box">
    <div class="box-header">
        ...
        <div class="sub_menu">
            <a href="<?php echo site_url('system_settings/add_customer_group'); ?>" data-toggle="modal" 
                data-backdrop="static" data-keyboard="false" data-target="#myModal"
                class="btn btn-success btn-block box_sub_menu" tabindex="-1">
                <i class="fa fa-plus"></i> <?= lang('add_customer_group') ?>
            </a>
        </div>
        <div class="sub_menu">
        ...
        <div class="sub_menu">
            <a href="#" id="delete" data-action="delete" class="btn btn-danger btn-block box_sub_menu" tabindex="-1">
                <i class="fa fa-trash-o"></i> <?= lang('delete_customer_groups') ?>
            </a>
        </div>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-users"></i><?= lang('customer_group'); ?></h2>
                </li>
            </ul>
        </div>
    </div>
