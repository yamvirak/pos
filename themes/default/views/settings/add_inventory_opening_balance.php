...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '#ivodate', function (e) {
            localStorage.setItem('ivodate', $(this).val());
        });
        if (ivodate = localStorage.getItem('ivodate')) {
            $('#ivodate').val(ivodate);
        }
        <?php } ?>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_inventory_opening_balance'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("system_settings/add_inventory_opening_balance", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['system_settings-date']) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "ivodate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control input-tip datetime" id="ivodate" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="col-md-4 <?= ((!$Owner && !$Admin && !$GP['reference_no']) ? 'hidden' : '') ?>">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control input-tip" id="ivoref"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div
                                class="fprom-group"><?php echo form_submit('add_inventory_opening_balance', lang("submit"), 'id="add_inventory_opening_balance" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
