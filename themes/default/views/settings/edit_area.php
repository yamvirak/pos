...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("system_settings/edit_area/" . $id, $attrib); ?>
        <div class="modal-body">
            <p><?= lang('enter_info'); ?></p>
			<div class="form-group">
                <label class="control-label" for="name"><?php echo $this->lang->line("name"); ?></label>
                <?php echo form_input('name', $area->name, 'class="form-control" id="name" required="required"'); ?>
            </div>
			<div class="form-group">
				...
				<div class="controls">
					...
					echo form_dropdown('city_id', $ct, $area->city_id, 'id="city_id" class="form-control"');
					?>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="district_box">
					<?php
						...
						echo form_dropdown('district_id', $ds, $area->district_id, 'id="district_id" class="form-control"');
					?>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="commune_box">
					<?php
						...
						echo form_dropdown('commune_id', $cm, $area->commune_id, 'id="commune_id" class="form-control"');
					?>
				</div>
			</div>
