...
<div class="box">
    <div class="box-header">
        ...
        <div class="sub_menu">
            <a href="<?php echo site_url('system_settings/add_expense_category'); ?>" data-toggle="modal" 
        ...
        <div class="sub_menu">
            <a href="<?php echo site_url('system_settings/import_expense_categories'); ?>" data-toggle="modal" 
                data-backdrop="static" data-keyboard="false" data-target="#myModal"
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-folder-open tip"></i><?= lang('expense_categories'); ?></h2>
                </li>
            </ul>
        </div>
    </div>
