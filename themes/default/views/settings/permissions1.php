                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
								...
								<?php if($this->config->item('inventory')) { ?>
									<tr>
										...
										<td>
											...
											<input type="checkbox" value="1" id="products-price_list" class="checkbox" name="products-price_list" <?php echo $p->{'products-price_list'} ? "checked" : ''; ?>>
											<label for="products-price_list" class="padding05"><?= lang('price_list') ?> </label>
								...
								<?php if($this->config->item('saleman_commission')){ ?>
									<tr>
										<td><?= lang("salesman_commissions"); ?></td>
										<td class="text-center">
											<input type="checkbox" value="1" class="checkbox" name="sales-salesman_commissions" <?php echo $p->{'sales-salesman_commissions'} ? "checked" : ''; ?>>
										</td>
										<td class="text-center">
											<input type="checkbox" value="1" class="checkbox" name="sales-add_salesman_commission" <?php echo $p->{'sales-add_salesman_commission'} ? "checked" : ''; ?>>
										</td>
										<td class="text-center">
											<input type="checkbox" value="1" class="checkbox" name="sales-edit_salesman_commission" <?php echo $p->{'sales-edit_salesman_commission'} ? "checked" : ''; ?>>
										</td>
										<td class="text-center">
											<input type="checkbox" value="1" class="checkbox" name="sales-delete_salesman_commission" <?php echo $p->{'sales-delete_salesman_commission'} ? "checked" : ''; ?>>
										</td>
										<td>
											<input type="checkbox" value="1" id="sales-salesman_commission-date" class="checkbox" name="sales-salesman_commission-date" <?php echo $p->{'sales-salesman_commission-date'} ? "checked" : ''; ?>>
											<label for="sales-salesman_commission-date" class="padding05"><?= lang('date') ?></label>
										</td>
									</tr>
								<?php } if($this->config->item('receive_payment')){ ?>
									<tr>
										<td><?= lang("receive_payments"); ?></td>
										<td class="text-center">
											<input type="checkbox" value="1" class="checkbox" name="sales-receive_payments" <?php echo $p->{'sales-receive_payments'} ? "checked" : ''; ?>>
										</td>
										<td class="text-center">
											<input type="checkbox" value="1" class="checkbox" name="sales-add_receive_payment" <?php echo $p->{'sales-add_receive_payment'} ? "checked" : ''; ?>>
										</td>
										<td class="text-center">
											<input type="checkbox" value="1" class="checkbox" name="sales-edit_receive_payment" <?php echo $p->{'sales-edit_receive_payment'} ? "checked" : ''; ?>>
										</td>
										<td class="text-center">
											<input type="checkbox" value="1" class="checkbox" name="sales-delete_receive_payment" <?php echo $p->{'sales-delete_receive_payment'} ? "checked" : ''; ?>>
										</td>
										<td>
											<input type="checkbox" value="1" id="sales-receive_payments-date" class="checkbox" name="sales-receive_payments-date" <?php echo $p->{'sales-receive_payments-date'} ? "checked" : ''; ?>>
											<label for="sales-receive_payments-date" class="padding05"><?= lang('date') ?></label>
										</td>
									</tr>	
								...
								<?php } if($this->config->item('purchase')) { ?>
									...
									<tr>
										...
										<td>
											<input type="checkbox" value="1" id="purchases-import_purchase" class="checkbox" name="purchases-import_purchase" <?php echo $p->{'purchases-import_purchase'} ? "checked" : ''; ?>>
											<label for="purchases-import_purchase" class="padding05"><?= lang('import_purchase') ?></label>
								...
								<?php }  if($this->config->item('concretes')){ ?>
									<tr>
										...
										<td>
											...
											<label for="concretes-officers" class="padding05"><?= lang('officer') ?></label>
								...
								<tr>
                                    ...
                                    <td colspan="5">
										...
										<span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="system_settings-date" name="system_settings-date" <?php echo $p->{'system_settings-date'} ? "checked" : ''; ?>>
                                            <label for="system_settings-date" class="padding05"><?= lang('date') ?></label>
                                        </span>
                                        <span style="inline-block">
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
										<?php if($this->config->item('inventory')) { ?>
											...
											<span style="inline-block">
												<input type="checkbox" value="1" class="checkbox" id="inventory_valuation_report" name="reports-inventory_valuation_report" <?php echo $p->{'reports-inventory_valuation_report'} ? "checked" : ''; ?>>
												<label for="inventory_valuation_report" class="padding05"><?= lang('inventory_valuation_report') ?></label>
											</span>
											<?php if($this->config->item('using_stocks')){?>
												<span style="inline-block">
										...
										<?php } if($this->config->item('saleman')){ ?>
											...
											<?php if($this->config->item('saleman_commission')){ ?>
												<span style="inline-block">
													<input type="checkbox" value="1" class="checkbox" id="salesman_commission_report" name="reports-salesman_commission_report" <?php echo $p->{'reports-salesman_commission_report'} ? "checked" : ''; ?>>
													<label for="salesman_commission_report" class="padding05"><?= lang('salesman_commission_report') ?></label>
												</span>
											<?php } ?>
										<?php } if($this->config->item('sale')) { ?>
											<span style="inline-block">
										...
										<?php } if($this->config->item("purchase")){ ?>
											...
											<span style="inline-block">
												<input type="checkbox" value="1" class="checkbox" id="receive_items_report" name="reports-receive_items_report" <?php echo $p->{'reports-receive_items_report'} ? "checked" : ''; ?>>
												<label for="receive_items_report" class="padding05"><?= lang('receive_items_report') ?></label>
											</span>
											<span style="inline-block">
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
										...
										<span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="reference_no"name="reference_no" <?php echo $p->reference_no ? "checked" : ''; ?>>
                                            <label for="reference_no" class="padding05"><?= lang('reference_no') ?></label>
                                        </span>
										<?php if($this->config->item('sale')){ ?>
											<span style="inline-block">
