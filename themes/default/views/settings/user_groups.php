...
<div class="box">
    <div class="box-header">
        ...
        <div class="sub_menu">
            <a href="<?= site_url('system_settings/create_group'); ?>" data-toggle="modal" 
        ...
        <div class="sub_menu">
            <a href="#" id="excelProducts" data-action="export_excel" class="btn btn-warning btn-block box_sub_menu" tabindex="-1">
                <i class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?> 
            </a>      
        </div>
        <div class="sub_menu">
            <a href="#" id="deleteGroups" data-action="delete" class="btn btn-danger btn-block box_sub_menu" tabindex="-1">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-users tip"></i><?= lang('groups'); ?></h2>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        foreach ($groups as $group) {
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <?php echo '<a class="tip" title="' . $this->lang->line("change_permissions") . '" href="' . site_url('system_settings/permissions/' . $group->id) . '"><i class="fonts fa fa-tasks"></i></a> <a class="tip" title="' . $this->lang->line("edit_group") . '" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal" href="' . site_url('system_settings/edit_group/' . $group->id) . '"><i class="fonts fa fa-edit"></i></a> <a href="#" class="tip po" title="' . $this->lang->line("delete_group") . '" data-content="<p>' . lang('r_u_sure') . '</p><a class=\'btn btn-danger\' href=\'' . site_url('system_settings/delete_group/' . $group->id) . '\'>' . lang('i_m_sure') . '</a> <button class=\'btn po-close\'>' . lang('no') . '</button>"><i class="fonts fa fa-trash-o"></i></a>'; ?>
                                </td>
                            </tr>
                        <?php
                        }
