<script>
    $(document).ready(function () {
        var oTable = $('#TaData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getTables') ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            },null, null, null, null, {"mRender": row_status}, {"bSortable": false}],
...
<?php if ($Owner) {
    echo form_open('system_settings/table_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        <div class="sub_menu"></div>
        <div class="sub_menu">
            <a class="btn btn-success btn-block box_sub_menu" href="<?php echo site_url('system_settings/add_table'); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal">
                <i class="fa fa-plus-circle"></i> <?= lang('add_table') ?>
            </a>
        </div>
        <div class="sub_menu">
             <a class="btn btn-warning btn-block box_sub_menu" href="<?php echo site_url('system_settings/import_tables'); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal">
                <i class="fa fa-plus-circle"></i> <?= lang('import_tables') ?>
             </a>
        </div>
        <div class="sub_menu">
        ...
        <div class="sub_menu">
            <a href="#" id="delete" data-action="delete" class="btn btn-danger btn-block box_sub_menu">
                <i class="fa fa-trash-o"></i> <?= lang('delete_tables') ?>
            </a>
        </div>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-folder-open"></i><?= lang('tables'); ?></h2>
                </li>
            </ul>
        </div>
    </div>
