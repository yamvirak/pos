...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('import_tables'); ?></h4>
        </div>
        <?php
			$attrib = array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form');
			echo form_open_multipart("system_settings/import_tables", $attrib)
        ?>
        <div class="modal-body">
			<a href="<?php echo base_url(); ?>assets/csv/sample_tables.xls" class="btn btn-primary pull-right">
