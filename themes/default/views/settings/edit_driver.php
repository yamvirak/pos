<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open("system_settings/edit_driver/".$id, $attrib); ?>
		<div class="modal-body">
			...
			<div class="form-group">
				...
				<?php echo form_textarea('address', $row->address, 'class="form-control" id="address"'); ?>
			</div>
		</div>
		<div class="modal-footer">
			<?php echo form_submit('edit_driver', lang('edit_driver'), 'class="btn btn-primary"'); ?>
		</div>
	</div>
	 <?php echo form_close(); ?>
</div>
