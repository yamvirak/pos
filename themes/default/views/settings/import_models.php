...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('import_models'); ?></h4>
        </div>
        <?php
        $attrib = array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form');
        echo form_open_multipart("system_settings/import_models", $attrib)
        ?>
        <div class="modal-body">
            <a href="<?php echo base_url(); ?>assets/csv/sample_models.csv" class="btn btn-primary pull-right">
            ...
            <div class="well well-small">
                ...
                <span class="text-info">
                    (<?= lang("name") . ', ' . lang("code") . ', ' . lang("brand"); ?>)
                </span> <?= lang("csv3"); ?>
            </div>
