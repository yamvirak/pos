...
<div class="modal-dialog">
    <div class="modal-content">
		...
		if($type=='expense'){
			echo form_open_multipart("purchases/add_payment/0/" . $inv->id, $attrib);
		}else{
			echo form_open_multipart("purchases/add_payment/" . $inv->id, $attrib);
		}
		
		$inv->grand_total = ($inv->grand_total + (isset($inv->return_paid) ? $inv->return_paid : 0)) - (isset($inv->return_total) ? $inv->return_total : 0);
        ?>
                    ...
                    <div class="col-md-12">
                        <div class="row">
							...
							foreach($currencies as $currency){
								...
								$base_amount = $this->cus->formatDecimal(($inv->grand_total - $inv->paid - $discount_inv) / $base_currency->rate);
