...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("purchases/edit_payment_return/" . $payment->id, $attrib); ?>
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <input type="hidden" value="<?php echo ($payment->purchase_id?$payment->purchase_id:0); ?>" name="purchase_id"/>
				<input type="hidden" value="<?php echo ($payment->expense_id?$payment->expense_id:0); ?>" name="expense_id"/>
                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" readonly
                                               value="<?= $this->cus->formatDecimal($payment->amount *(-1)); ?>" type="text"
