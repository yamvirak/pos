...
<script>
    $(document).ready(function () {
        oTable = $('#TOData1').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('transfers/getTransfers/'.($biller ? $biller->id : '')); ?>',
            ...
            "aoColumns": [{"mRender": checkbox}, {"mRender": fld}, null, null, null,  {"mRender": row_status}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}],
...
<div class="box">
    <div class="box-header">
		<!-- <h2 class="blue"><i class="fa-fw fa fa-star-o"></i><?= lang('transfers').' ('.($biller ? $biller->name : lang('all_billers')).')'; ?></h2>	 -->
        <div class="sub_menu"></div>
        <div class="sub_menu">
            <a class="btn btn-success btn-block box_sub_menu" href="<?= site_url('transfers/add') ?>">
                <i class="fa fa-plus-circle"></i> <?= lang('add_transfer') ?>
             </a>
        </div>
        <div class="sub_menu">
            <a href="#" class="btn btn-warning btn-block box_sub_menu"  id="excel" data-action="export_excel">
                <i class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?>
            </a>
        </div>
        <div class="sub_menu">
            <a href="#" class="bpo btn btn-danger btn-block box_sub_menu"  title="<b><?= $this->lang->line("delete_transfers") ?></b>"
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-retweet"></i><?= lang('transfers'); ?></h2>
                </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                    <table id="TOData1" cellpadding="0" cellspacing="0" border="0"
