...
<body class="login-page">
    ...
    <div class="page-back" style="background:#428BCA !important;">
		<div id="particles-js"  style="position: absolute; width:100%; height: 100% !important">
			<script type="text/javascript" src="<?= $assets ?>js/login_particles.js"></script>
			<script type="text/javascript" src="<?= $assets ?>js/login_annimation.js"></script>
		</div>
        <div id="login">
            <div class="container">
                ...
                <div class="login-form-div">
                    ...
                    <div class="login-content">
						...
						<div class="div-title col-sm-12">
                            <h3 style="font-size:16px;"><?= lang('login_to_your_account') ?></h3>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="textbox-wrap form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" autofocus value="<?= DEMO ? 'owner@sunfixconsulting.com' : ''; ?>" required="required" class="form-control" name="identity"
