<script>
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('auth/getAgencies') ?>',
			...
			{column_number: 5, filter_default_label: "[<?=lang('commission');?>]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[<?=lang('total_percent_withdraw');?>]", filter_type: "text", data: []},
            {
...
<?php 
    echo form_open('auth/agency_actions', 'id="action-form"');
 ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
						<li>
                            <a href="<?= site_url('auth/add_agency'); ?>" data-backdrop='static' data-keyboard='false' data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal" id="add">
						...
						<li class="divider"></li>
						<li><a href="#" class="bpo" title="<b><?= $this->lang->line("delete_agencies") ?></b>"
							   data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>"
							   data-html="true" data-placement="left"><i
									class="fa fa-trash-o"></i> <?= lang('delete_agencies') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('limit_percent'); ?>(%)</th>
