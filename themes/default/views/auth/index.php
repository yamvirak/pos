...
<div class="box">
    <div class="box-header">
        ...
        <div class="sub_menu">
            <?php if($this->config->item('add_user')== true){ ?>
                <a href="<?= site_url('auth/create_user'); ?>" class="btn btn-success btn-block box_sub_menu" tabindex="-1">
                <i class="fa fa-plus-circle"></i> <?= lang("add_user"); ?>
                </a>
            <?php } ?>
        </div>
        <div class="sub_menu">
            <a href="#" id="excel" data-action="export_excel" class="btn btn-warning btn-block box_sub_menu" tabindex="-1"><i
                class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?>
            </a>
        </div>
        <div class="sub_menu">
            <?php if($this->config->item('add_user')== true){ ?>
                <a href="#" class="bpo btn btn-danger btn-block box_sub_menu" tabindex="-1"
                    ...
                    class="fa fa-trash-o"></i> <?= lang('delete_users') ?>
                </a>
            <?php } ?>  
        </div>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-users"></i><?= lang('users'); ?></h2>
                </li>
            </ul>
        </div>
    </div>
