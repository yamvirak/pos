...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(window).bind('beforeunload', function (e) {
            $.get('<?= site_url('welcome/set_data/remove_sols/1'); ?>');
            if (count > 1) {
        ...
        $('#edit_sale_order').click(function () {
            $(window).unbind('beforeunload');            
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('edit_sale_order'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("sale_orders/edit/" . $id, $attrib)
                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4 <?= ((!$Owner && !$Admin && !$GP['reference_no']) ? 'hidden' : '') ?>">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control input-tip" id="soref"'); ?>
                            </div>
                        </div>
                        <?php if ($Owner || $Admin || !$this->session->userdata('biller_id')) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $inv->biller_id), 'id="sobiller" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        <?php } else {
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="no-project">
											...
											echo form_dropdown('project', $pj, (isset($_POST['project']) ? $_POST['project'] : $inv->project_id), 'id="project" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("project") . '" required="required" style="width:100%;" ');
											?>
										</div>
									</div>
								</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $inv->warehouse_id), 'id="sowarehouse" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . '" required="required" style="width:100%;" ');
								?>
							</div>
						</div>
                                ...
                                <div class="panel-body" style="padding: 5px;">
									...
									<?php if ($this->config->item('saleman')==true && ($Owner || $Admin || $GP['sales-assign_sales'])) { ?>
										<div class="col-md-4">
											...
											?>
											<?= form_dropdown('saleman_id', $opsalemans, (isset($_POST['saleman_id']) ? $_POST['saleman_id'] : $inv->saleman_id), ' id="saleman_id" class="form-control" required="required"'); ?>
											</div>
										</div>
									<?php } ?>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('discount', '', 'class="form-control input-tip" id="sodiscount" '.(($Owner || $Admin || $this->session->userdata('allow_discount')) ? '' : 'readonly="true"')); ?>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col-md-4 hidden">
                            <div class="form-group">
                                ...
                                <?php if ($Owner || $Admin || $GP['suppliers-add'] || $GP['suppliers-index']) { ?><div class="input-group"><?php } ?>
                                    <input type="hidden" name="supplier" value="" id="sosupplier"
						...
						<div class="col-sm-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('payment_term', $pt,(isset($_POST['payment_term']) ? $_POST['payment_term'] : $inv->payment_term), 'class="form-control input-tip" id="sopayment_term"'); ?>
                        ...
                        <div class="col-sm-12">
                            <div
                                class="fprom-group"><?php echo form_submit('edit_sale_order', $this->lang->line("submit"), 'id="edit_sale_order" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
