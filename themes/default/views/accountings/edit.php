...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("accountings/editAccount/".$account->id, $attrib); ?>
        ...
        <div class="modal-body">
			...
			<div class="form-group">
                ...
                echo form_dropdown('section', $pgs, $account->section_id, 'class="form-control tip select" id="section" required="required" style="width:100%;'.(isset($is_parent->last_code) && $is_parent->last_code!=''?'pointer-events:none;':'').'"');
                ?>
            </div>
			<div class="form-group">
                <label class="control-label" for="parent_code"><?php echo $this->lang->line("parent_account"); ?></label>
                <select name="parent_code" class="form-control tip select" id="parent_code" style="width:100%; <?= ($is_parent->last_code!=""?'pointer-events:none;':'') ?>">
            ...
            <div class="form-group">
                ...
                <?php echo form_input('code', $account->code, 'class="form-control" id="code" required="required"'); ?>
            </div>
            <div class="form-group">
                <label class="control-label" for="name"><?php echo $this->lang->line("name"); ?></label>
                <?php echo form_input('name', $account->name, 'class="form-control" id="name" required="required"'); ?>
            </div>
            ...
            <div class="form-group">
                ...
                echo form_dropdown('is_cash', $pg_iscash, $account->is_cash, 'class="form-control tip select" id="is_cash" required="required" style="width:100%;"');
                ?>
            </div>
			<div class="form-group">
                ...
                echo form_dropdown('inactive', $pg_inactive, $account->inactive, 'class="form-control tip select" id="inactive" required="required" style="width:100%;"');
                ?>
            </div>
