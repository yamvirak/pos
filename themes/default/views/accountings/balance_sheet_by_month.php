        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("accountings/balance_sheet_by_month"); ?>
                    ...
                    <th>
                        <tr> 
                                ...
                                <div class="bold" style="font-size:15px;font-family: Khmer OS Muol Light;">
                                        <?= lang('balance_sheet_by_month_report_kh')?>
                                </div> 
                                <div class="bold">
                                        <?= lang('balance_sheet_by_month_report')?>
                                </div><br>
                            </td> 
                        </tr>
                </table>
				...
				<?php
					...
					$getAccTranAmounts = $this->accountings_model->getMonthAccTranAmounts(false,1);
					...
					$getNetIncomeMonths = $this->accountings_model->getMonthAmountNetIncome(false);
					...
					function getSubAccount($subAccounts,$accTrans,$accTranMonths, $months, $year, $billers, $projects){
						...
						foreach($subAccounts as $subAccount){
							...
							if(isset($_POST['sub_account']) && $_POST['sub_account']=='yes'){
								if(isset($accTrans[$subAccount->code])){
					...
					function getSubSubAccount($SubSubAccounts,$accTrans,$accTranMonths, $months, $year, $billers, $projects){
						...
						foreach($SubSubAccounts as $SubSubAccount){
							...
							$total_amount += $amount;
							if(isset($_POST['sub_account']) && $_POST['sub_account']=='yes'){
								if(isset($accTrans[$SubSubAccount->code])){
								//if(formatDecimal($amount) != 0){
                                    $sub_td_month = '';										
                                    foreach($months as $month => $value){
					...
					foreach($balance_sheets as $balance_sheet){
						...
						$tbody .="<tr style='font-weight:bold; color:#327bf7'><td style='text-align:left' colspan='".$colspan_main."'><span>".$main_section."</span></td></tr>";
						...
						if($sections){
							foreach($sections as $section){
								...
								$tbody .="<tr style='color:#067740; font-weight:bold'><td style='text-align:left'><span>&nbsp;&nbsp;&nbsp;&nbsp;".lang("total").' '.$section->name."</span></td>
											".$td_section_month."
										</tr>";
								...
								if($balance_sheet=='EQ'){
									...
									$tbody .="<tr style='color:#067740; font-weight:bold'><td style='text-align:left'><span>&nbsp;&nbsp;&nbsp;&nbsp;".lang('total')." ".lang('net_income')."</span></td>
													".$td_net_month."
												</tr>";
								}		
							}
						...
						$tbody .="<tr style='font-weight:bold; color:#327bf7'><td style='text-align:left'><span>".lang("total").' '.$main_section."</span></td>
									".$td_main_section_month."
								</tr>";
					...
					$tbody .="<tr style='font-weight:bold; color:#327bf7'><td style='text-align:left'><span>".lang('total')." ".lang('liabilities')." ".lang('and')." ".lang('equities')."</span></td>
								".$td_li_qu_month."			
							</tr>";
				?>
