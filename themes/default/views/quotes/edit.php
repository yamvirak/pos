...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        <?php if ($inv) { ?>
        localStorage.setItem('qudate', '<?= date($dateFormats[($Settings->date_with_time == 0 ? 'php_sdate' : 'php_ldate')], strtotime($inv->date))?>');
		...
		localStorage.setItem('qusaleman', '<?= $inv->saleman_id ?>');
		...
		localStorage.setItem('qupayment_term', '<?= $inv->payment_term ?>');
		localStorage.setItem('quvalid_day', '<?= $inv->valid_day ?>');
        <?php } ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4 <?= ((!$Owner && !$Admin && !$GP['reference_no']) ? 'hidden' : '') ?>">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control input-tip" id="quref" '); ?>
                            </div>
                        </div>
