        ...
        <table>
                        ...
                        <table>
                            <tr>
                                <td valign="bottom" style="width:40%"><hr class="hr_title"></td>
                                    <td class="text_center" style="width:25%"><span style="font-size:<?= $font_size+5 ?>px" class="inv_invoice_kh"> <?= lang('quote_invoice_kh') ?> </span><span class="inv_invoice">/ <?= lang('quote_invoice') ?></span></td>
            ...
            <tbody>
                <?php
                    ...
                    $footer_note = '<td class="footer_des" rowspan="'.$footer_rowspan.'" colspan="'.$footer_colspan.'"><span style="font-style: italic;" class="bold">'.lang("អត្រាប្តូរប្រាក់").' : 1 ដុល្លារ = '.($currency->rate).'</span>'.$this->cus->decode_html($biller->invoice_footer1).'</td>';
                    if ($inv->grand_total != $inv->total) {
                        $tfooter .= '<tr>
                                        '.$footer_note.'
