        ...
        <div class="col-lg-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    <tr>
                        ...
                        ?>
                        <td style="text-align:right;"><?= $this->cus->formatMoney($inv->total + $inv->product_tax); ?></td>
                    </tr>
                    <?php
                    if ($inv->order_discount != 0) {
                        echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang("order_discount") . ' (' . $default_currency->code . ')</td><td style="text-align:right;">'.($inv->order_discount_id ? '<small>('.$inv->order_discount_id.')</small> ' : '') . $this->cus->formatMoney($inv->order_discount) . '</td></tr>';
                    }
                    if ($Settings->tax2 && $inv->order_tax != 0) {
                        echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang("order_tax") . ' (' . $default_currency->code . ')</td><td style="text-align:right;">' . $this->cus->formatMoney($inv->order_tax) . '</td></tr>';
                    }
                    if ($inv->shipping != 0) {
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; font-weight:bold;"><?= $this->cus->formatMoney($inv->grand_total); ?></td>
                    </tr>
            ...
            <div class="row">
                ...
                <div class="col-xs-4  pull-left">
                    <p><?= lang("seller"); ?>: <?= $biller->name != '-' ? $biller->name : $biller->company; ?> </p>
