							...
							<th>
								<table>
									<tr>
										...
										<?php if($payment->type == 'received' || $payment->type == 'returned'){ ?>
					...
					<tbody>
						<?php
							...
							$tbody .='<tr>
											...
											<td class="text_left">'.$inv->reference_no.'</td>
											<td class="text_center">'.$this->cus->hrsd($inv->date).'</td>
							...
							<td>
								<table class="table_item">
									...
									<tbody id="tfooter">
										...
										<?php if($payment->note){ ?>
											<tr>
												<td style="border:none !important" colspan="4"><b><?= lang('note') ?> : </b><?= $this->cus->decode_html($payment->note); ?></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
