                        ...
                        <table>
                            <tr>
                                <td valign="bottom" style="width:35%"><hr class="hr_title"></td>
                                    <td class="text_center" style="width:35%"><span style="font-size:<?= $font_size+5 ?>px" class="c"> <?= lang('inv_purchase_order_kh') ?> </span><span class="inv_invoice">/ <?= lang('purchase_order') ?></span></td>
