...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (!localStorage.getItem('prtax2')) {
            localStorage.setItem('prtax2', <?=$Settings->default_tax_rate2;?>);
        }
        ItemnTotals();
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("purchase_requests/add", $attrib)
                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4 hidden">
                            <div class="form-group">
                                ...
                                <?php echo form_input('discount', '', 'class="form-control input-tip" id="prdiscount"'); ?>
                            </div>
                        </div>
                        <?php } ?>
