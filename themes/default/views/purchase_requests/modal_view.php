...
<div class="modal-dialog modal-lg main_content">
                        ...
                        <table>
                            <tr>
                                <td valign="bottom" style="width:35%"><hr class="hr_title"></td>
                                    <td class="text_center" style="width:40%"><span style="font-size:<?= $font_size+5 ?>px" class="c"> <?= lang('inv_purchase_request_kh') ?> </span><span class="inv_invoice">/ <?= lang('purchase_request') ?></span></td>
									...
									<td style="width:60%">
										<fieldset>
											...
											<table>
												...
												<tr>
													<td><?= lang('address') ?></td>
													<td> : <?= $supplier->address.$customer->city ?></td>
												</tr>
												<tr>
													<td><?= lang('tel') ?></td>
						...
						foreach ($rows as $row){
							...
							$tbody .='<tr>
											...
											<td class="text_left">
												...
												'.($row->product_note ? '<br>' . nl2br($row->product_note) : '').'
											</td>
                        ...
                        <table class="table_item_main">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="70"><?=lang("លេខកូដ<br>Code");?></th>
                ...
                <tr class="tr_print bold">
                    <td>
                        <table style="margin-top:<?= $margin_signature ?>px;">
                            <tr>
                                <td class="text_center" style="width:30%"><?= lang("inv_supplier") ?></td>
                            ...
                            <tr>
                                <td class="text_center" style="width:30%">ឈ្មោះ <strong><?= $supplier->company ?></strong></td>
    ...
    <div id="buttons" style="padding:10px 0px 10px 0px" class="no-print">
				...
				<div class="btn-group btn-group-justified">
					...
					<?php } ?>
					<div class="btn-group">
						<a href="<?= site_url('purchase_orders/email/' . $inv->id) ?>" data-toggle="modal" data-target="#myModal2" class="tip btn btn-primary" title="<?= lang('email') ?>">
					...
					<?php if($inv->status != 'completed'){ ?>
						<div class="btn-group">
							<a href="<?= site_url('purchase_orders/edit/' . $inv->id) ?>" class="tip btn btn-warning sledit" title="<?= lang('edit') ?>">
