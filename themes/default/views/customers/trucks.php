...
<script>
    $(document).ready(function () {
        $('#CTData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('customers/getTrucks/'.$customer->id) ?>',
...
<?= form_open('customers/truck_actions/'.$customer->id, 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo site_url('customers/add_truck/'.$customer->id); ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('add_truck') ?>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> <?= lang('delete_truck') ?>
                            </a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="CTData" class="table table-bordered table-hover table-striped">
                        <thead>
							<tr>
