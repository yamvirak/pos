...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('view_message'); ?></h4>
        </div>
            ...
            <div class="table-responsive">
                <table id="DepData" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr class="primary">
                        ...
                        <th class="col-xs-3"><?= lang("message"); ?></th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            oTable = $('#DepData').dataTable({
                ...
                'sAjaxSource': '<?= site_url('customers/get_messages/') ?>',
                ...
                "aoColumns": [{"mRender": fld}, null, null, null, {"bSortable": false}]
            });
