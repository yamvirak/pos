    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="well well-small">
                <a href="<?php echo base_url(); ?>assets/csv/customer_sample.xlsx" class="btn btn-primary pull-right"><i
                        class="fa fa-download"></i> Download Sample File</a>
                <span class="text-warning"><?= lang("csv1"); ?></span><br/><?= lang("csv2"); ?> <span class="text-info">(<?= lang("code").', '.lang("company") . ', ' . lang("name") . ', ' . lang("email") . ', ' . lang("phone") . ', ' . lang("customer_group") . ', ' . lang("price_group") . ', ' . lang("address") . ', ' . lang("city"); ?>
