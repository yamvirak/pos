    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div id="logo-con" class="text-center"><img width="300px" height="80px" src="<?= base_url('assets/uploads/logos/' . $biller->logo) ?>" alt=""></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
					...
					<div class="form-group">
                        <?= lang("prefix", "prefix"); ?>
                        <?php echo form_input('prefix', $prefix->bill_prefix, 'class="form-control" id="prefix"'); ?>
                    </div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select name="default_cash" id="default_cash" class="form-control default_cash" required="required">
							...
							<?= $this->cus->cash_opts($biller->default_cash,true,false,true); ?>
						</select>
					</div>
				</div>
				<div class="col-md-6">
				...
				<?php if($this->config->item('concretes')){ ?>
					<div class="col-md-6">
						<div class="form-group">
							...
							<?php echo form_input('start_hour', $biller->start_hour, 'class="form-control timepicker" id="start_hour"'); ?>
						</div>
						<div class="form-group">
							<?= lang("office_commission_rate", "office_commission_rate"); ?>
							<?php echo form_input('office_commission_rate', $biller->office_commission_rate, 'class="form-control" id="office_commission_rate"'); ?>
						</div>
						
						<div class="form-group">
							<?= lang("pump_commission_rate", "pump_commission_rate"); ?>
							<?php echo form_input('pump_commission_rate', $biller->pump_commission_rate, 'class="form-control" id="pump_commission_rate"'); ?>
						</div>
						<div class="form-group">
							<?= lang("truck_commission_rate", "truck_commission_rate"); ?>
							<?php echo form_input('truck_commission_rate', $biller->truck_commission_rate, 'class="form-control" id="truck_commission_rate"'); ?>
						</div>
						<div class="form-group">
							<?= lang("big_truck_commission_rate", "big_truck_commission_rate"); ?>
							<?php echo form_input('big_truck_commission_rate', $biller->big_truck_commission_rate, 'class="form-control" id="big_truck_commission_rate"'); ?>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<?= lang("end_hour", "end_hour"); ?>
							<?php echo form_input('end_hour', $biller->end_hour, 'class="form-control timepicker" id="end_hour"'); ?>
						</div>
						<div class="form-group">
							<?= lang("fuel_price", "fuel_price"); ?>
							<?php echo form_input('fuel_price', $biller->fuel_price, 'class="form-control"'); ?>
						</div>
						<div class="form-group">
							<?= lang("pump_commission_rate_assistant", "pump_commission_rate_assistant"); ?>
							<?php echo form_input('pump_commission_rate_assistant', $biller->pump_commission_rate_assistant, 'class="form-control" id="pump_commission_rate_assistant"'); ?>
						</div>
						<div class="form-group">
							<?= lang("truck_commission_rate_ot", "truck_commission_rate_ot"); ?>
							<?php echo form_input('truck_commission_rate_ot', $biller->truck_commission_rate_ot, 'class="form-control" id="truck_commission_rate_ot"'); ?>
						</div>
						<div class="form-group">
							<?= lang("big_truck_commission_rate_ot", "big_truck_commission_rate_ot"); ?>
							<?php echo form_input('big_truck_commission_rate_ot', $biller->big_truck_commission_rate_ot, 'class="form-control" id="big_truck_commission_rate_ot"'); ?>
						</div>
					</div>
				...
				<div class="col-md-6">
					...
					<div class="form-group">
                        ...
                        <select name="other_income_account" class="form-control select" id="other_income_account" style="width:100%">
							<option value=""><?= lang('select').' '.lang('other_income_account') ?></option>
					...
					<?php if($Settings->installment==1){ ?>
						<div class="form-group">
							...
							<select name="installment_outstanding_account" class="form-control select" id="installment_outstanding_account" style="width:100%">
								<option value=""><?= lang('select').' '.lang('installment_outstanding_account') ?></option>
						...
						<div class="form-group">
							...
							<select name="installment_interest_account" class="form-control select" id="installment_interest_account" style="width:100%">
								<option value=""><?= lang('select').' '.lang('installment_interest_account') ?></option>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?php echo form_textarea('invoice_footer', $biller->invoice_footer, 'class="form-control" id="invoice_footer" style="height:100px;"'); ?>
                    </div>
                </div>
            </div>
        </div>
