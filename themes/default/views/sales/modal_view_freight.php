								...
								<table>
									<tr>
										<td valign="bottom" style="width:65%"><hr class="hr_title"></td>
										 ...
										 <td class="text_center" style="width:20%"><span style="font-size:<?= $font_size+5 ?>px"><b><i><?= lang('Freight Note') ?></i></b></span></td>
					...
					<tbody>
						<?php
							...
							foreach ($rows as $row){
								...
								$unit_cost = $inv->grand_total * ($row->unit_percent / 100); 
								...
								$tbody .='<tr>
												...
												<td class="text_center">'.$this->cus->formatQuantity($row->quantity).' '.$row->unit_name.'</td>
