        ...
        <div class="modal-body">
                    ...
                    <div class="card-content white-text">
                        <svg xmlns="http://www.w3.org/2000/svg" width="353px" height="206px" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <text x="5"  y="75" style="font-size:36;fill:#FFF;">
                                <?= $Settings->default_currency.' '.$this->cus->formatMoney($gift_card->value); ?>
                            </text>
                            ...
                            <text x="5"  y="115" style="font-size:16;fill:#FFF;">
                                <?= $gift_card->expiry ? lang('expiry').': '.$this->cus->hrsd($gift_card->expiry) : ''; ?>
                            </text>
                            <image xlink:href="<?= $this->cus->save_barcode($gift_card->card_no, 'code128', 50, true, true); ?>" x="-10" y="135" height="50" width="353" />
                        </svg>
                    </div>
            ...
            if ($topups) {
                ...
                foreach ($topups as $topup) {
                    echo '<tr>';
                    echo '<td>'.$this->cus->hrld($topup->date).'</td>';
                    echo '<td>'.$this->cus->formatMoney($topup->amount).'</td>';
