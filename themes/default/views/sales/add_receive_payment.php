...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_receive_payment'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php
					...
					echo form_open_multipart("sales/add_receive_payment", $attrib);
                ?>
                <div class="row">
					<div class="col-md-12">
						<?php if ($Owner || $Admin || $GP['sales-receive_payments-date']) { ?>
							<div class="col-md-4">
								<div class="form-group">
									<?= lang("date", "rpdate"); ?>
									<?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control input-tip datetime" id="rpdate" required="required"'); ?>
								</div>
							</div>
						<?php } ?>
						<div class="col-md-4 <?= ((!$Owner && !$Admin && !$GP['reference_no']) ? 'hidden' : '') ?>">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control input-tip" id="rpref"'); ?>
                            </div>
                        </div>
						<?php if ($Owner || $Admin || !$this->session->userdata('biller_id')) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $Settings->default_biller), 'id="rpbiller" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        <?php } else {
                                ...
                                <div class="panel-body" style="padding: 5px;">
									<div class="col-md-3">
										<div class="form-group">
											...
											<?php echo form_input('from_date', (isset($_POST['from_date']) ? $_POST['from_date'] : ""), 'class="form-control input-tip datetime" id="rpfrom_date" required="required"'); ?>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<?= lang("to_date", "rpto_date"); ?>
											<?php echo form_input('to_date', (isset($_POST['to_date']) ? $_POST['to_date'] : ""), 'class="form-control input-tip datetime" id="rpto_date" required="required"'); ?>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											...
											<?php
												...
												echo form_dropdown('received_by', $ct_opt, (isset($_POST['received_by']) ? $_POST['received_by'] : ''), 'id="rpreceived_by" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("received_by") . '"  class="form-control input-tip select"');
											?>
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select name="paid_by" id="rppaid_by" class="form-control rppaid_by">
												<?= $this->cus->cash_opts('empty',false,true); ?>
											</select>
										</div>
									</div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-12">
                            <div class="fprom-group">
								<?php echo form_submit('add_receive_payment', $this->lang->line("submit"), 'id="add_receive_payment" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
							</div>
                        </div>
                    </div>
                </div>
