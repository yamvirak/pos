	...
	<div class="modal-dialog"​>
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><?php echo lang('assign_to'); ?></h4>
			</div>
			<?php $attrib = array('data-toggle' => '', 'role' => 'form');
			echo form_open_multipart("sales/assign_to/".$id, $attrib); ?>
				...
				<div class="row">
				   ...
				   <div class="col-sm-12">
						...
						<?php if ($Owner || $Admin) { ?>
							...
							?>
							<?= form_dropdown('created_by', $users, 0, 'class="form-control" required="required"'); ?>
							</div>
						...
						<div class="form-group">
							...
							?>
							<?= form_dropdown('assign_to', $users, 0, 'class="form-control" required="required"'); ?>
						</div>
			...
			<div class="modal-footer">
				<?php echo form_submit('submit', lang('assign_to'), 'class="btn btn-primary"'); ?>
			</div>
		</div>
		<?php echo form_close(); ?>
	</div>
