    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td width="70%"><?php echo $this->cus->hrld($delivery->date); ?></td>
            </tr>
            <tr>
            ...
            <?php if ($delivery->note) { ?>
                <tr>
                    ...
                    <td><?php echo $this->cus->decode_html($delivery->note); ?></td>
                </tr>
            <?php } ?>
            </tbody>
            ...
            foreach ($rows as $row): ?>
                <tr>
                    ...
                    <td style="width: 150px; text-align:center; vertical-align:middle;">
                        <?= $this->cus->formatQuantity($row->unit_quantity).' '.$row->product_unit_code; ?>
                    </td>
                </tr>
                <?php
                $r++;
