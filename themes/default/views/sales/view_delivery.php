            ...
            <?php if ($logo) { ?>
                <div class="text-center" style="margin-bottom:20px;">
                    <img src="<?= base_url() . 'assets/uploads/logos/' . $biller->logo; ?>"
                         alt="<?= $biller->name != '-' ? $biller->name : $biller->company; ?>">
                </div>
            <?php } ?>
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td width="70%"><?= $this->cus->hrld($delivery->date); ?></td>
                    </tr>
                    <tr>
                    ...
                    <?php if ($delivery->note) { ?>
                        <tr>
                            <td><?= lang("note"); ?></td>
                            <td><?= $this->cus->decode_html($delivery->note); ?></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    foreach ($rows as $row): ?>
                        <tr>
                            ...
                            <td style="width: 150px; text-align:center; vertical-align:middle;"><?= $this->cus->formatQuantity($row->unit_quantity).' '.$row->product_unit_code; ?></td>
                        </tr>
                        <?php
                        $r++;
                    endforeach;
