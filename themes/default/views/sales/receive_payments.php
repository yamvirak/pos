...
<script>
    $(document).ready(function () {
        oTable = $('#RPData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sales/getReceivePayments/'.($biller ? $biller->id : '')) ?>',
            ...
            "aoColumns": [{"mRender": checkbox}, {"mRender": fld}, null, {"mRender": fsd}, {"mRender": fsd}, {"mRender": currencyFormat}, null, {"mRender": row_status}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}],
...
<?php if ($Owner || $Admin || $GP['bulk_actions']) {
    echo form_open('sales/receive_payment_actions', 'id="action-form"');
} ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= site_url('sales/add_receive_payment') ?>"><i class="fa fa-plus-circle"></i> <?= lang('add_receive_payment') ?>
                            </a>
                        </li>
                        <li>
				...
				<?php if (!empty($billers) && $this->config->item('one_biller')==false) { ?>
					<li class="dropdown">
						...
						<ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
							<li><a href="<?= site_url('sales/receive_payments') ?>"><i class="fa fa-industry"></i> <?= lang('all_billers') ?></a></li>
							<li class="divider"></li>
							<?php
							foreach ($billers as $biller) {
								echo '<li><a href="' . site_url('sales/receive_payments/null/'.$biller->id) . '"><i class="fa fa-home"></i>' . $biller->name . '</a></li>';
							}
							?>
						</ul>
					</liv>
