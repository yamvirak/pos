...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_salesman_payment'); ?></h4>
        </div>
        <?php 
			$attrib = array('data-toggle' => 'validator', 'role' => 'form');
			echo form_open_multipart("sales/add_salesman_payment/" . $commission->id, $attrib);
        ?>
                ...
                <div class="well well-sm well_1">
                    <div class="col-md-12">
                        <div class="row">
							...
							$base_amount = $this->cus->formatDecimal(($commission->total_commission - $commission->paid) / $base_currency->rate);
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_salesman_payment', lang('add_salesman_payment'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
