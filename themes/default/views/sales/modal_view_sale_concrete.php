		...
		<div class="modal-body">
			<table>
						...
						<th>
							<table>
								<tr>
									...
									<td class="text_center" style="width:30%"><span style="font-size:<?= $font_size+5 ?>px"><b><i><?= lang('concreted_statement') ?></i></b></span></td>
				...
				<tbody>
					<?php
						...
						if($sale_items){
							foreach ($sale_items as $sale_item){
								$tbody .='<tr>
												...
												<td class="text_center">'.$sale_item->reference_no.'</td>
												<td class="text_center">'.$this->cus->hrld($sale_item->date).'</td>
												<td class="text_left">'.$sale_item->casting_type_name .'</td>
												...
												<td class="text_right">'.$this->cus->formatMoney($sale_item->subtotal).'</td>
											</tr>';
						...
						$tfooter = '';
						$footer_note = '<td class="footer_des" rowspan="'.$footer_rowspan.'" colspan="'.$footer_colspan.'"></td>';
						if ($sale->grand_total != $subtotal) {
							$tfooter .= '<tr>
											'.$footer_note.'
			...
			<div id="buttons" style="padding-top:10px;" class="no-print">
				...
				<div class="btn-group btn-group-justified">
					...
					<div class="btn-group">
						<a href="<?= site_url('sales/modal_view_sale_concrete/' . $sale->id.'/daily') ?>" class="tip btn btn-success" title="<?= lang('daily_invoice') ?>" data-toggle="modal" data-target="#myModal2" data-backdrop="static" data-keyboard="false">
							<i class="fa fa-file-text-o"></i>
							<span class="hidden-sm hidden-xs"><?= lang('daily_invoice') ?></span>
						</a>
					</div>
					<div class="btn-group">
						<a href="<?= site_url('sales/modal_view_sale_concrete/' . $sale->id.'/short') ?>" class="tip btn btn-success" title="<?= lang('short_invoice') ?>" data-toggle="modal" data-target="#myModal2" data-backdrop="static" data-keyboard="false">
							<i class="fa fa-file-text-o"></i>
							<span class="hidden-sm hidden-xs"><?= lang('short_invoice') ?></span>
						</a>
					</div>
