...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <?= lang("value", "value"); ?>
                <?php echo form_input('value', $this->cus->formatDecimal($gift_card->value), 'class="form-control" id="value" required="required"'); ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php echo form_input('expiry', $this->cus->hrsd($gift_card->expiry), 'class="form-control date" id="expiry"'); ?>
            </div>
