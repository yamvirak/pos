           ...
           <tr>
                <th>
                    <table style="margin-top:50px">
                        <tr>
                            <td class="text_center" style="width:100%"><span style="font-size:<?= $font_size+8 ?>px"><b style="font-family: Khmer OS Muol Light;">
                                <?= lang('delivery_note_kh') ?></b>/<b><?= lang('delivery_note') ?></b></span></td>
                        </tr>
                        <tr>
