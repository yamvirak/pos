                        ...
                        <table>
                            <tr>
                                <td valign="bottom" style="width:25%"><hr class="hr_title"></td>
                                    <td class="text_center" style="width:20%"><span style="font-size:<?= $font_size+5 ?>px" class="inv_invoice_kh"> <?= lang('inv_invoice_kh') ?> </span><span class="inv_invoice">/ <?= lang('inv_invoice') ?></span></td>
                                <td valign="bottom" style="width:25%"><hr class="hr_title"></td>
                            </tr>
                        </table>
                    </th>
                                    ...
                                    <fieldset>
                                        <table border="1" class="table_item_head">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:180px;"><?= lang('inv_date') ?> </td>
                                                <td style="text-transform: uppercase;"> <strong><?= $this->cus->hrld($inv->date) ?></strong>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-transform: uppercase;"> <strong><?= $customer->phone;?></strong>
                                                </td>
                                            </tr>
                                        </table>
                                    </fieldset>
                ...
                <?php
                    ...
                    foreach ($rows as $row){
                        ...
                        $tbody .='<tr style="vertical-align: top;">
                                        ...
                                        <td class="text_left">
                                            <b>'.$this->cus->remove_tag($row->product_name).'</b>
                    ...
                    if ($inv->product_tax  != 0) {
                        $tfooter .= '<tr>
                                        '.$footer_note.'
                                        <td class="text_right" colspan="2"><b>'.lang("product_tax").'</b></td>
                                        <td class="text_right"><b>'.$this->cus->formatMoney($inv->product_tax).'</b></td>
                                    </tr>';
                        $footer_note = '';      
                    }
                    if ($inv->total_tax  != 0) {
                    ...
                    $tfooter .= '<tr>
                                    '.$footer_note.'
                                    <td class="text_right bold"><p style="margin:4px 0 4px 0px !important; line-height:18px;">'.lang("អាករលើតម្លៃបន្ថែម") ." ". $this->cas->numberToKhmer($tax->rate).' %<br/>'.$tax->name.'</p></td>
                                    <td class="text_right"><b>'.$this->cas->formatMoney($inv->total_tax).'</b></td>
                                </tr>';
                    $footer_note = '';      
                }
                        ...
                        <table class="table_item_main">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"><?=lang("ប្រភេទបន្ទប់ <br> Description");?></th>
	...
	<div class="buttons" style="margin-top:20px; margin-bottom:20px">
		<div class="btn-group btn-group-justified">
			...
			<div class="btn-group hidden">
				<a href="<?= site_url('sales/modal_view_tax/' . $inv->id) ?>" class="tip btn btn-success" title="<?= lang('tax_invoice') ?>" data-toggle="modal" data-target="#myModal2" data-backdrop="static" data-keyboard="false">
