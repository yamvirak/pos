<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
    ...
    <ul id="myTab" class="nav nav-tabs">
		...
		<?php if($product->type != 'raw_material') { ?>
			<?php if($this->config->item('saleorder') && ($GP['sale_orders-index'] || $Admin || $Owner)){ ?>
				<li class=""><a href="#sale_orders" class="tab-grey"><?= lang('sale_orders') ?></a></li>
			<?php } if(($GP['reports-sales'] || $Admin || $Owner)){ ?>
				<li class=""><a href="#sales" class="tab-grey"><?= lang('sales') ?></a></li>
			<?php } if($this->config->item('quotation') && ($GP['quotes-index'] || $Admin || $Owner)){ ?>
				<li class=""><a href="#quotes" class="tab-grey"><?= lang('quotes') ?></a></li>
			<?php } ?>
        <?php } if($product->type == 'standard' || $product->type == 'raw_material' || $product->type == 'asset') { ?>
			<?php if($GP['reports-purchases'] || $Admin || $Owner){ ?>
				<li class=""><a href="#purchases" class="tab-grey"><?= lang('purchases') ?></a></li>
			<?php } if($this->config->item('receive_item')){ ?>
				<li class=""><a href="#receives" class="tab-grey"><?= lang('receives') ?></a></li>
			<?php } ?>
			<?php if(!$this->config->item('one_warehouse') && ($GP['reports-transfers'] || $Admin || $Owner)){ ?>
				<li class=""><a href="#transfers" class="tab-grey"><?= lang('transfers') ?></a></li>
			<?php } if($GP['reports-adjustments'] || $Admin || $Owner){ ?>
				<li class=""><a href="#damages" class="tab-grey"><?= lang('quantity_adjustments') ?></a></li>
			<?php } if($this->config->item('using_stocks') && ($GP['reports-using_stocks'] || $Admin || $Owner)){?>
				<li class=""><a href="#usings" class="tab-grey"><?= lang('using_stocks') ?></a></li>
			<?php } ?>	
		<?php } ?>
		<li class=""><a href="#histories" class="tab-grey"><?= lang('product_histories') ?></a></li>
		<li class=""><a href="#document" class="tab-grey"><?= lang('document') ?></a></li>
		<?php if($Settings->product_license == 1){?>
			<li class=""><a href="#licenses" class="tab-grey"><?= lang('licenses') ?></a></li>
		<?php } ?> 
...
<div class="tab-content">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:70%;">
                                                <?= $this->cus->save_barcode($product->code, $product->barcode_symbology, 66, false); ?>
                                                <?= $this->cus->qrcode('link', urlencode(site_url('products/view/' . $product->id)), 2); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang("type"); ?></td>
                                        ...
                                        <?php if ($subcategory && $product->subcategory_id) { ?>
                                            <tr>
                                        ...
                                        <?php if ($Owner || $Admin) {
                                            echo '<tr><td>' . lang("cost") . '</td><td>' . $this->cus->formatMoney($product->cost) . '</td></tr>';
                                            echo '<tr><td>' . lang("price") . '</td><td>' . $this->cus->formatMoney($product->price) . '</td></tr>';
											
											if($this->config->item('product_currency')==true && $product->currency_code != $Settings->default_currency){
												echo '<tr><td></td><td style="color:#ff0000">' . $this->cus->formatOtherMoney($product->price * $product->currency_rate, $product->currency_code, -1) . '</td></tr>';
											}
                                            if ($product->promotion) {
                                                echo '<tr><td>' . lang("promotion") . '</td><td>' . $this->cus->formatMoney($product->promo_price) . ' ('.$this->cus->hrsd($product->start_date).' - '.$this->cus->hrsd($product->end_date).')</td></tr>';
                                            }
                                        } else {
                                            ...
                                            if ($this->session->userdata('show_price')) {
                                                echo '<tr><td>' . lang("price") . '</td><td>' . $this->cus->formatMoney($product->price) . '</td></tr>';
                                                if ($product->promotion) {
                                                    echo '<tr><td>' . lang("promotion") . '</td><td>' . $this->cus->formatMoney($product->promo_price) . ' ('.$this->cus->hrsd($product->start_date).' - '.$this->cus->hrsd($product->start_date).')</td></tr>';
                                                }
                                            }
                                        }
                                        ?>
                                        ...
                                        <?php if ($product->alert_quantity != 0) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $this->cus->formatQuantity($product->alert_quantity); ?></td>
                                            </tr>
                                        <?php } ?>
                                        <?php if ($variants) { ?>
                                            <tr>
                                                ...
                                                <table
                                                    ...
                                                    <?php foreach ($warehouses as $warehouse) {
                                                        if ($warehouse->quantity != 0) {
                                                            echo '<tr><td>' . $warehouse->name . ' (' . $warehouse->code . ')</td><td><strong>' . $this->cus->formatQuantity($warehouse->quantity) . '</strong>' . ($warehouse->rack ? ' (' . $warehouse->rack . ')' : '') . '</td></tr>';
                                                        }
                                                    } ?>
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <?php foreach ($combo_items as $combo_item) {
                                                        echo '<tr><td>' . $combo_item->name . ' (' . $combo_item->code . ') </td><td>' . $this->cus->formatQuantity($combo_item->qty) . '</td></tr>';
                                                    } ?>
                                                    </tbody>
                                                </table>
                                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    foreach ($options as $option) {
                                                        if ($option->wh_qty != 0) {
                                                            echo '<tr><td>' . $option->wh_name . '</td><td>' . $option->name . '</td><td class="text-center">' . $this->cus->formatQuantity($option->wh_qty) . '</td>';
                                                            if ($Owner || $Admin && (!$Customer || $this->session->userdata('show_cost'))) {
                                                                echo '<td class="text-right">' . $this->cus->formatMoney($option->cost) . '</td><td class="text-right">' . $this->cus->formatMoney($option->price) . '</td>';
                                                            }
                                                            echo '</tr>';
                                                        }
    ...
    <div id="chart" class="tab-pane fade">
        <script src="<?= $assets; ?>js/hc/highcharts_product.js"></script>
        <script type="text/javascript">
            $(function () {
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                oTable = $('#SlRData').dataTable({
                    ...
                    "aoColumns": [{"mRender": checkbox, "bVisible":false}, {"mRender": fld}, null, null, null, {
                        "bSearchable": false,
                        "mRender": pqFormat
                    ...
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        var gtotal = 0, paid = 0, balance = 0, discount=0, greturn = 0;
						...
						nCells[6].innerHTML = currencyFormat(parseFloat(greturn));
	...
	<div id="sale_orders" class="tab-pane fade">
        <script type="text/javascript">
            $(document).ready(function () {
                oTable = $('#QuRData2').dataTable({
                    "aaSorting": [[0, "desc"]],
                    "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('reports/getSaleOrdersReport/?v=1&product='.$product->id) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
                    ...
                    'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                        ...
                        nRow.id = aData[7];
                        nRow.className = "sale_order_link";
                        return nRow;
                    },
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            <a href="#" id="pdf6" class="tip" title="<?= lang('download_pdf') ?>">
                                <i class="icon fa fa-file-pdf-o"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a href="#" id="xls6" class="tip" title="<?= lang('download_xls') ?>">
                                <i class="icon fa fa-file-excel-o"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a href="#" id="image6" class="tip image" title="<?= lang('save_image') ?>">
                                <i class="icon fa fa-file-picture-o"></i>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="introtext"><?php echo lang('list_results'); ?></p>
                        <div class="table-responsive">
                            <table id="QuRData2" class="table table-bordered table-hover table-striped table-condensed">
                                <thead>
                                <tr>
                                    <th><?= lang("date"); ?></th>
                                    <th><?= lang("reference_no"); ?></th>
	...
	<div id="histories" class="tab-pane fade">
        <script type="text/javascript">
            $(document).ready(function () {
                oTable = $('#QuRData3').dataTable({
                    "aaSorting": [[0, "desc"]],
                    "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('reports/getProductHistoriesReport/?v=1&product='.$product->id) ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
					...
					"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        var quantity = 0;
                        for (var i = 0; i < aaData.length; i++) {
                            quantity += parseFloat(aaData[aiDisplay[i]][4]);
                        }
                        var nCells = nRow.getElementsByTagName('th');
                        nCells[4].innerHTML = formatQuantity(parseFloat(quantity));
                    }
                }).fnSetFilteringDelay().dtFilter([
                    {column_number: 0, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            <a href="#" id="pdf7" class="tip" title="<?= lang('download_pdf') ?>">
                                <i class="icon fa fa-file-pdf-o"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                        ...
                        <li class="dropdown">
                            <a href="#" id="image7" class="tip image" title="<?= lang('save_image') ?>">
                                <i class="icon fa fa-file-picture-o"></i>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table id="QuRData3" class="table table-bordered table-hover table-striped table-condensed">
                                <thead>
                                <tr>
                                    <th><?= lang("date"); ?></th>
    ...
    <div id="purchases" class="tab-pane fade">
        <script type="text/javascript">
            $(document).ready(function () {
                oTable = $('#PoRData').dataTable({
                    ...
                    "aoColumns": [{"mRender": checkbox, "bVisible":false},{"mRender": fld}, null, null, null,null,null, {
						"bSearchable": false,
						"mRender": pqFormat
                    ...
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
						...
						nCells[8].innerHTML = currencyFormat(parseFloat(returned));
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue">
					<i class="fa-fw fa fa-star nb"></i><?= $product->name . ' ' . lang('purchases'); ?>
                </h2>
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown">
	...
	<div id="receives" class="tab-pane fade">
        <script>
            $(document).ready(function () {
                oTable = $('#receiveData').dataTable({
                    "aaSorting": [[0, "desc"]],
                    "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('reports/getReceivesReport/?v=1&product='.$product->id); ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
                    ...
                    "aoColumns": [{"mRender": fld}, null, null, null, {"bSortable": false, "mRender": pqFormat}, null, {"mRender": decode_html}],
                    'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                        nRow.id = aData[7];
                    ...
                    {column_number: 0, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
                    {column_number: 1, filter_default_label: "[<?=lang('reference_no');?>]", filter_type: "text", data: []},
					{column_number: 2, filter_default_label: "[<?=lang('purchase');?>]", filter_type: "text", data: []},
                    {column_number: 3, filter_default_label: "[<?=lang('warehouse');?>]", filter_type: "text", data: []},
        ...
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-filter"></i><?= lang('receives_report'); ?><?php
                ...
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown"><a href="#" id="pdf8" class="tip" title="<?= lang('download_pdf') ?>"><i
                                    class="icon fa fa-file-pdf-o"></i></a></li>
                        <li class="dropdown"><a href="#" id="xls8" class="tip" title="<?= lang('download_xls') ?>"><i
                                    class="icon fa fa-file-excel-o"></i></a></li>
                        <li class="dropdown"><a href="#" id="image8" class="tip image"
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table id="receiveData" class="table table-bordered table-condensed table-hover table-striped">
                                <thead>
                                <tr>
                                    <th class="col-xs-2"><?= lang("date"); ?></th>
                                    <th class="col-xs-2"><?= lang("reference_no"); ?></th>
									<th class="col-xs-2"><?= lang("purchase"); ?></th>
	...
	<div id="document" class="tab-pane fade">
        <script>
            $(document).ready(function () {
                oTable = $('#documentData').dataTable({
                    "aaSorting": [[0, "desc"]],
                    "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('products/getDocuments/'.$product->id); ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
                    ...
                    "aoColumns": [
								...
								null,
								null,
								{"sClass" : "center", "mRender" : attachment,"bSearchable" : false, "bSortable" : false}, 
					...
					<ul class="btn-tasks">
						<li class="dropdown">
							...
							<ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
								<li><a href="<?php echo site_url('products/add_document/'.$product->id); ?>" data-toggle="modal" data-target="#myModal" ><i class="fa fa-plus-circle"></i> <?= lang('add_document') ?></a></li>
						   </ul>
						</li>
					</ul>
				</div>
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="introtext"><?= lang('list_results'); ?></p>
                        <div class="table-responsive">
                            <table id="documentData" class="table table-bordered table-condensed table-hover table-striped">
                                <thead>
									<tr>
	...
	<div id="licenses" class="tab-pane fade">
        <script>
            $(document).ready(function () {
                oTable = $('#licenseData').dataTable({
                    "aaSorting": [[0, "desc"]],
                    "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
                    "iDisplayLength": <?= $Settings->rows_per_page ?>,
                    'bProcessing': true, 'bServerSide': true,
                    'sAjaxSource': '<?= site_url('products/getLicense/'.$product->id); ?>',
                    'fnServerData': function (sSource, aoData, fnCallback) {
                        aoData.push({
                            "name": "<?= $this->security->get_csrf_token_name() ?>",
                            "value": "<?= $this->security->get_csrf_hash() ?>"
					...
					{column_number: 0, filter_default_label: "[<?=lang('issued_date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
					{column_number: 1, filter_default_label: "[<?=lang('valid_date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
					{column_number: 2, filter_default_label: "[<?=lang('description');?>]", filter_type: "text", data: []},
					{column_number: 3, filter_default_label: "[<?=lang('created_by');?>]", filter_type: "text", data: []},
                ], "footer");
            });
                ...
                <div class="box-icon">
					<ul class="btn-tasks">
						<li class="dropdown">
							<a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon fa fa-tasks tip"  data-placement="left" title="<?= lang("actions") ?>"></i></a>
							<ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
								<li><a href="<?php echo site_url('products/add_license/'.$product->id); ?>" data-toggle="modal" data-target="#myModal" ><i class="fa fa-plus-circle"></i> <?= lang('add_license') ?></a></li>
						   </ul>
						</li>
					</ul>
				</div>
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="introtext"><?= lang('list_results'); ?></p>
                        <div class="table-responsive">
                            <table id="licenseData" class="table table-bordered table-condensed table-hover table-striped">
                                <thead>
									<tr>
										<th><?php echo lang('issued_date'); ?></th>
										<th><?php echo lang('valid_date'); ?></th>
										<th><?php echo lang('description'); ?></th>
										<th><?php echo lang('created_by'); ?></th>
										<th><i class="fa fa-chain"></i></th>
										<th><?php echo lang('actions'); ?></th>
	...
	<div id="usings" class="tab-pane fade">
        <script>
            $(document).ready(function () {
                oTable = $('#usingData').dataTable({
                   "aaSorting": [[0, "desc"]],
					"aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
					"iDisplayLength": <?= $Settings->rows_per_page ?>,
					'bProcessing': true, 'bServerSide': true,
					'sAjaxSource': '<?= site_url('reports/getUsingStockDetailReport/?v=1&product='.$product->id); ?>',
					'fnServerData': function (sSource, aoData, fnCallback) {
						aoData.push({
							"name": "<?= $this->security->get_csrf_token_name() ?>",
							"value": "<?= $this->security->get_csrf_hash() ?>"
					...
					{column_number: 1, filter_default_label: "[<?=lang('reference_no')?>]", filter_type: "text", data: []},
					{column_number: 2, filter_default_label: "[<?=lang('warehouse');?>]", filter_type: "text", data: []},
					{column_number: 3, filter_default_label: "[<?=lang('using_by');?>]", filter_type: "text", data: []},
					{column_number: 4, filter_default_label: "[<?=lang('product')?>]", filter_type: "text", data: []},
					{column_number: 5, filter_default_label: "[<?=lang('using_quantity')?>]", filter_type: "text", data: []},
					{column_number: 6, filter_default_label: "[<?=lang('return_quantity')?>]", filter_type: "text", data: []},
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            <a href="#" id="pdf9" class="tip" title="<?= lang('download_pdf') ?>">
                                <i class="icon fa fa-file-pdf-o"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a href="#" id="xls9" class="tip" title="<?= lang('download_xls') ?>">
                                <i class="icon fa fa-file-excel-o"></i>
                            </a>
                        </li>
                        <li class="dropdown">
                            <a href="#" id="image9" class="tip image" title="<?= lang('save_image') ?>">
                                <i class="icon fa fa-file-picture-o"></i>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table id="usingData" class="table table-bordered table-condensed table-hover table-striped">
                                <thead>
                                <tr>
									<th class="col-xs-2"><?= lang("date"); ?></th>
									<th class="col-xs-2"><?= lang("reference"); ?></th>
									<th class="col-xs-2"><?= lang("warehouse")  ?></th>
									<th class="col-xs-2"><?= lang("using_by")  ?></th>
									<th class="col-xs-2"><?= lang("product")  ?></th>
									<th class="col-xs-2"><?= lang("using_quantity")  ?></th>
									<th class="col-xs-2"><?= lang("return_quantity")  ?></th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
			...
			$('#pdf6').click(function (event) {
                event.preventDefault();
                window.location.href = "<?=site_url('reports/getSaleOrdersReport/pdf/?v=1&product='.$product->id)?>";
                return false;
            });
            $('#xls6').click(function (event) {
                event.preventDefault();
                window.location.href = "<?=site_url('reports/getSaleOrdersReport/0/xls/?v=1&product='.$product->id)?>";
                return false;
            });
			$('#pdf7').click(function (event) {
                event.preventDefault();
                window.location.href = "<?=site_url('reports/getProductHistoriesReport/pdf/?v=1&product='.$product->id)?>";
                return false;
            });
            $('#xls7').click(function (event) {
                event.preventDefault();
                window.location.href = "<?=site_url('reports/getProductHistoriesReport/0/xls/?v=1&product='.$product->id)?>";
                return false;
            });
			
			$('#pdf8').click(function (event) {
                event.preventDefault();
                window.location.href = "<?=site_url('reports/getReceivesReport/pdf/?v=1&product='.$product->id)?>";
                return false;
            });
            $('#xls8').click(function (event) {
                event.preventDefault();
                window.location.href = "<?=site_url('reports/getReceivesReport/0/xls/?v=1&product='.$product->id)?>";
                return false;
            });
			
			$('#pdf9').click(function (event) {
                event.preventDefault();
                window.location.href = "<?=site_url('reports/getUsingStockDetailReport/pdf/?v=1&product='.$product->id)?>";
                return false;
            });
            $('#xls9').click(function (event) {
                event.preventDefault();
                window.location.href = "<?=site_url('reports/getUsingStockDetailReport/0/xls/?v=1&product='.$product->id)?>";
                return false;
            });
...
<style type="text/css">
	<?php if(!$Settings->project){ ?>
		#PoRData th:nth-child(4), #PoRData td:nth-child(4){
			display:none !important;
		}
	<?php } ?>
		#PoRData th:nth-child(14), #PoRData td:nth-child(14){
			display:none !important;
		}
