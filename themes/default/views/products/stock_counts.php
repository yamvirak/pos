...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#STData').dataTable({
            ...
            "aoColumns": [
                {"mRender": checkbox}, {"mRender": fld}, null, null, {"mRender": count_type}, null, null, {"bSortable": false, "mRender": attachment2}, {"bSortable": false, "mRender": attachment}, {"bSortable": false}
            ]
...
<div class="box">
    <div class="box-header">
        ...
        <div class="sub_menu">
            <a href="<?= site_url('products/count_stock') ?>" class="btn btn-success btn-block box_sub_menu" tabindex="-1">
                <i class="fa fa-plus-circle"></i> <?= lang('add_stock_count') ?>
            </a>
        </div>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <h2 class="blue"><i class="icon fa fa-th-list"></i><?= lang('stock_counts'); ?></h2>
                </li>
