...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_scan_stock'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("products/add_scan_stock/".$id, $attrib)
                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('warehouse_id', $wh, (isset($_POST['warehouse_id']) ? $_POST['warehouse_id'] : ''), 'id="warehouse_id" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . '" required="required" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                class="from-group"><?php echo form_submit('add_scan_stock', $this->lang->line("submit"), 'id="add_scan_stock" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
