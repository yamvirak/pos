    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("boms/add", $attrib);
                ?>
					<?php if ($Owner || $Admin || $GP['products-date']) { ?>
						<div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="form-group">
							<?= lang("name", "name"); ?>						   							
							<?php echo form_input('name', (isset($_POST['name']) ? $_POST['name'] : set_value('name')),'class="form-control input-tip" id="name"'); ?>
						</div>
					</div>
					...
					<!-- Button Submit -->
					<div class="col-md-12">
						<div class="fprom-group"><?php echo form_submit('add_sale', lang("submit"), 'id="bth_bom_items" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
							<button type="button" name="bom_items" class="btn btn-danger" id="reset"><?= lang('reset') ?></button></div>
					</div>
                <?php echo form_close(); ?>
            </div>
        </div>
