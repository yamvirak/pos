...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        <?php if ($adjustment) { ?>
        localStorage.setItem('qadate', '<?= $this->cus->hrld($adjustment->date); ?>');
                        ...
                        <?php if ($Owner || $Admin || $GP['products-adjustments-date']) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "qadate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->cus->hrld($adjustment->date)), 'class="form-control input-tip datetime" id="qadate" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
