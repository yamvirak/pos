						...
						<table style="margin-top: 10px;">
                            <tr>
                                ...
                                <td class="text_center" style="width:20%">
									<?= $this->cus->qrcode('link', urlencode(site_url('products/view_convert/' . $convert->id)), 2); ?>
								</td>
                            </tr>
                        </table>
						</th>
						...
						<th>
							<table>
								<tr>
									<td style="width:60%">
										<fieldset>
											<legend style="font-size:<?= $font_size ?>px"><b><i><?= lang('inv_warehouses_info') ?></i></b></legend>
											<table>
                                                ...
                                                <tr>
													<td><?= lang('ផ្លូវ') ?></td>
													<td> : <strong><?= $biller->address ?></strong></td>
												</tr>
											</table>
										</fieldset>
									</td>
                                 <td style="width:40%">
										<fieldset style="margin-left:5px; !important">
											...
											<table>                        
												...
												<tr>
													<td><?= lang('inv_date') ?></td>
													<td style="text-align:left"> : <?= $this->cus->hrsd($convert->date) ?></td>
												</tr>
                                                <tr>
													<td><?= lang('inv_user') ?></td>
						...
						<td>
							...
							<thead>
								...
								<tfoot>
									<?php if($convert->note){?>
										<tr>
											<td style="border:0px !important" colspan="4"><b><?= lang('note') ?> : </b> <?= $this->cus->decode_html($convert->note)  ?></td>
										</tr>
									<?php } ?>
								</tfoot>
							</table>
                        ...
                        <td>
                            <table style="margin-top:<?= $margin_signature ?>px;">
                                ...
                                <tr>
                                    ...
                                    <td class="text_center" style="width:30%">ឈ្មោះ <strong></strong></td>
