                            ...
                            <table>
                                <tr>
                                    <td valign="bottom" style="width:35%"><hr class="hr_title"></td>
                                        <td class="text_center" style="width:20%"><span class="inv_invoice" style="font-size:<?= $font_size+5 ?>px"><?= lang('using_stock') ?></span></td>
						...
						<th>
							<table>
								<tr>
									<td style="width:60%">
										<fieldset>
											<legend style="font-size:<?= $font_size ?>px"><b><i><?= lang('inv_staff') ?></i></b></legend>
											<table>

												
												<?php if($using_by){ ?>
													<tr>
														<td><?= lang('inv_staff_by') ?></td>
														<td> : <strong><?= $using_by->first_name.' '.$using_by->last_name ?></strong></td>
													</tr>
												<?php } if($inv->customer){ ?>
													<tr>
														<td><?= lang('inv_customer') ?></td>
														<td> : <strong><?= $inv->customer ?></strong></td>
													</tr>
													<tr>
														<td><?= lang('inv_phone') ?></td>
														<td> : <strong><?= $using_by->phone ?></strong></td>
													</tr>
												<?php } ?>
											</table>
										</fieldset>
									...
									<td style="width:40%">
										<fieldset style="margin-left:5px !important">
											...
											<table>
												...
												<?php if($inv->return_date){ ?>
													<tr class="hidden">
														<td><?= lang('return_date') ?></td>
														<td style="text-align:left"> : <?= $this->cus->hrsd($inv->return_date) ?></td>
													</tr>
												<?php } ?>
											</table>
										</fieldset>
					...
					<?php
						...
						foreach ($rows as $row){
							...
							$tbody .='<tr>
											...
											<td class="text_right">'.$this->cus->formatQuantity(abs($row->unit_quantity)).' '.$row->unit_name.'</td>
											'.$expired_td.'
										</tr>';		
							$i++;
						}
							...
							<table class="table_item_main">
								<thead>
									<tr>
										...
										<th class="text-center" width="80"><?= lang("កូដ <br> Code"); ?></th>
										<th class="text-center" width="80"><?= lang("បរិយាយ <br> Description"); ?></th>
										<th class="text-center" width="80"><?= lang("បរិមាណ <br> Quantity"); ?></th>
