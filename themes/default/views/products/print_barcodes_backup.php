            ...
            <div class="col-lg-12">
                ...
                <div class="well well-sm no-print">
                    ...
                    <div class="controls table-controls">
                        ...
                        <div class="form-group">
                            <?= lang('style', 'style'); ?>
							<?php $opts = array('' => lang('select').' '.lang('style'), 405 => lang('40_per_sheet_a5'), 40 => lang('40_per_sheet'),56 => lang('56_per_sheet (a4) (2.056" x 0.857")'),60 => lang('60_per_sheet (a4) (1.545" x 1.028")'), 30 => lang('30_per_sheet'), 24 => lang('24_per_sheet'), 20 => lang('20_per_sheet'), 18 => lang('18_per_sheet'), 14 => lang('14_per_sheet'), 12 => lang('12_per_sheet'), 10 => lang('10_per_sheet'), 50 => lang('continuous_feed')); ?>                            
                    ...
                    <?php
                        if ($this->input->post('print')) {
                            if (!empty($barcodes)) {
                                ...
                                $c = 1;
                                if ($style == 12 || $style == 18 || $style == 24 || $style == 40 || $style == 56 || $style == 60) {
                                        ...
                                        if($item['price']) {
                                            ...
                                            if($item['currencies']) {
                                                foreach ($currencies as $currency) {
                                                    echo $currency->code . ': ' . $this->cus->formatMoney($item['price'] * $currency->rate).', ';
                                                }
                                            } else {
                                                echo $item['price'];
                                            }
