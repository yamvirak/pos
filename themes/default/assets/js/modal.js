...
$(function() {
	if(site.settings.date_with_time == 0 ){
		$('.datetime').datetimepicker({format: site.dateFormats.js_sdate, language: 'cus', todayBtn: 1, autoclose: 1, minView: 2 });
    }else{
		$('.datetime').datetimepicker({format: site.dateFormats.js_ldate, language: 'cus', weekStart: 1, todayBtn: 1, autoclose: 1, todayHighlight: 1, startView: 2, forceParse: 0});
	}
	$('.date').datetimepicker({format: site.dateFormats.js_sdate, language: 'cus', todayBtn: 1, autoclose: 1, minView: 2 });
});
