...
<legend style="color:#0000FF;">&nbsp;&nbsp;DATABASE:&nbsp; cas (Purchases:$db)&nbsp;&nbsp;&nbsp;QUERIES: 12 (0.0220 seconds)&nbsp;&nbsp;(<span style="cursor: pointer;" onclick="var s=document.getElementById('ci_profiler_queries_db_0').style;s.display=s.display=='none'?'':'none';this.innerHTML=this.innerHTML=='Hide'?'Show':'Hide';">Hide</span>)</legend>
...
<tr><td style="vertical-align:top;width:50%;padding:5px;color:#900;background-color:#ddd;">SCRIPT_NAME&nbsp;&nbsp;</td><td style="width:50%;padding:5px;color:#000;background-color:#ddd;">/cas/index.php</td></tr>
...
<tr><td style="padding:5px;vertical-align:top;color:#900;background-color:#ddd;">identity&nbsp;&nbsp;</td><td style="padding:5px;color:#000;background-color:#ddd;">owner@sunfixconsulting.com</td></tr>
...
<tr><td style="padding:5px;vertical-align:top;color:#900;background-color:#ddd;">email&nbsp;&nbsp;</td><td style="padding:5px;color:#000;background-color:#ddd;">owner@sunfixconsulting.com</td></tr>
...
<tr><td style="padding:5px;vertical-align:top;color:#900;background-color:#ddd;">base_url&nbsp;&nbsp;</td><td style="padding:5px;color:#000;background-color:#ddd;">http://localhost/cas/</td></tr>
...
<tr><td style="padding:5px;vertical-align:top;color:#900;background-color:#ddd;">cookie_prefix&nbsp;&nbsp;</td><td style="padding:5px;color:#000;background-color:#ddd;">cus_</td></tr>
...
(
    ...
    [admin_email] =&gt; veasna.rin@sunfixconsulting.com
...
<fieldset style="border:1px solid #0000FF;padding:6px 10px 10px 10px;margin:20px 0 20px 0;background-color:#eee;">
<legend style="color:#0000FF;">&nbsp;&nbsp;DATABASE:&nbsp; cas (system_settings:$db)&nbsp;&nbsp;&nbsp;QUERIES: 11 (0.0040 seconds)&nbsp;&nbsp;(<span style="cursor: pointer;" onclick="var s=document.getElementById('ci_profiler_queries_db_0').style;s.display=s.display=='none'?'':'none';this.innerHTML=this.innerHTML=='Hide'?'Show':'Hide';">Hide</span>)</legend>
...
<fieldset style="border:1px solid #0000FF;padding:6px 10px 10px 10px;margin:20px 0 20px 0;background-color:#eee;">
<legend style="color:#0000FF;">&nbsp;&nbsp;DATABASE:&nbsp; cas (system_settings:$db)&nbsp;&nbsp;&nbsp;QUERIES: 11 (0.0020 seconds)&nbsp;&nbsp;(<span style="cursor: pointer;" onclick="var s=document.getElementById('ci_profiler_queries_db_0').style;s.display=s.display=='none'?'':'none';this.innerHTML=this.innerHTML=='Hide'?'Show':'Hide';">Hide</span>)</legend>
